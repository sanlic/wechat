...
.field final GC:Landroid/view/Window$Callback;

.field final GD:Landroid/view/Window$Callback;

.field final GE:Landroid/support/v7/app/d;
...
.field iU:Landroid/view/MenuInflater;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/d;)V
    ...
    .line 65
    iput-object p2, p0, Landroid/support/v7/app/f;->Fp:Landroid/view/Window;

    .line 66
    iput-object p3, p0, Landroid/support/v7/app/f;->GE:Landroid/support/v7/app/d;
    ...
    iput-object v0, p0, Landroid/support/v7/app/f;->GC:Landroid/view/Window$Callback;
    ...
    iput-object v0, p0, Landroid/support/v7/app/f;->GD:Landroid/view/Window$Callback;

    .line 75
    iget-object v0, p0, Landroid/support/v7/app/f;->Fp:Landroid/view/Window;

    iget-object v1, p0, Landroid/support/v7/app/f;->GD:Landroid/view/Window$Callback;
...
.method abstract cV()V
.end method

.method final cW()Landroid/content/Context;
    .locals 2
...
.method public final getMenuInflater()Landroid/view/MenuInflater;
    ...
    .prologue
    .line 99
    iget-object v0, p0, Landroid/support/v7/app/f;->iU:Landroid/view/MenuInflater;

    if-nez v0, :cond_0

    .line 100
    invoke-virtual {p0}, Landroid/support/v7/app/f;->cV()V
    ...
    iput-object v1, p0, Landroid/support/v7/app/f;->iU:Landroid/view/MenuInflater;
...
.method public onDestroy()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/f;->GK:Z
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 214
    iput-object p1, p0, Landroid/support/v7/app/f;->uQ:Ljava/lang/CharSequence;
