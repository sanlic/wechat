...
# instance fields
.field private iE:Landroid/graphics/drawable/InsetDrawable;
...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/p;)V
    ...
    .line 46
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/m;->iA:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method final a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 55
    invoke-static {}, Landroid/support/design/widget/m;->af()Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->it:Landroid/graphics/drawable/Drawable;

    .line 56
    iget-object v0, p0, Landroid/support/design/widget/m;->it:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->iv:Landroid/support/design/widget/d;
    ...
    iget-object v3, p0, Landroid/support/design/widget/m;->iv:Landroid/support/design/widget/d;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Landroid/support/design/widget/m;->it:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/m;->iu:Landroid/graphics/drawable/Drawable;

    .line 73
    iget-object v0, p0, Landroid/support/design/widget/m;->iu:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Landroid/support/design/widget/m;->iw:Landroid/graphics/drawable/Drawable;

    .line 75
    iget-object v0, p0, Landroid/support/design/widget/m;->iB:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/m;->iu:Landroid/graphics/drawable/Drawable;
    ...
    .line 66
    :cond_1
    iput-object v4, p0, Landroid/support/design/widget/m;->iv:Landroid/support/design/widget/d;
...
.method final ae()Landroid/support/design/widget/d;
    .locals 1
...
.method final b(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0}, Landroid/support/design/widget/p;->Y()Z
    ...
    invoke-interface {v0}, Landroid/support/design/widget/p;->X()F

    move-result v0

    .line 162
    iget-object v1, p0, Landroid/support/design/widget/m;->iA:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v1}, Landroid/support/design/widget/VisibilityAwareImageButton;->getElevation()F

    move-result v1

    iget v2, p0, Landroid/support/design/widget/m;->iy:F
...
.method final c(Landroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->iE:Landroid/graphics/drawable/InsetDrawable;

    .line 128
    iget-object v0, p0, Landroid/support/design/widget/m;->iB:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/m;->iE:Landroid/graphics/drawable/InsetDrawable;
...
.method public final j(F)V
    ...
    .line 91
    invoke-virtual {p0}, Landroid/support/design/widget/m;->ad()V
...
.method final k(F)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/m;->iA:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 101
    sget-object v1, Landroid/support/design/widget/m;->iz:[I
