...
.method static synthetic a(Landroid/support/design/widget/k;Z)Z
    ...
    .prologue
    .line 25
    iput-boolean p1, p0, Landroid/support/design/widget/k;->ij:Z
...
.method final a(Landroid/support/design/widget/l$a;Z)V
    ...
    .line 46
    iget-boolean v0, p0, Landroid/support/design/widget/k;->ij:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/k;->iA:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    invoke-virtual {v0, v1, v4}, Landroid/support/design/widget/VisibilityAwareImageButton;->b(IZ)V
...
.method final ac()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/k;->ik:Landroid/support/design/widget/o;
    ...
    iget v3, v1, Landroid/support/design/widget/o;->fK:F

    cmpl-float v3, v3, v2

    if-eqz v3, :cond_0

    iput v2, v1, Landroid/support/design/widget/o;->fK:F

    invoke-virtual {v1}, Landroid/support/design/widget/o;->invalidateSelf()V

    :cond_0
    iget-object v1, p0, Landroid/support/design/widget/k;->iv:Landroid/support/design/widget/d;
    ...
    iget v2, v1, Landroid/support/design/widget/d;->fK:F

    cmpl-float v2, v0, v2

    if-eqz v2, :cond_1

    iput v0, v1, Landroid/support/design/widget/d;->fK:F
...
.method final b(Landroid/support/design/widget/l$a;Z)V
    ...
    invoke-virtual {v0, v4, v4}, Landroid/support/design/widget/VisibilityAwareImageButton;->b(IZ)V
