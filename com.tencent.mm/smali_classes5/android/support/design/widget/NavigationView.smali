...
# instance fields
.field private final iQ:Landroid/support/design/internal/a;

.field private final iR:Landroid/support/design/internal/b;

.field private iS:Landroid/support/design/widget/NavigationView$a;

.field private iT:I

.field private iU:Landroid/view/MenuInflater;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/NavigationView;->dU:[I
    ...
    sput-object v0, Landroid/support/design/widget/NavigationView;->iP:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->iR:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->iQ:Landroid/support/design/internal/a;

    .line 107
    sget-object v0, Landroid/support/design/a$i;->cM:[I

    sget v1, Landroid/support/design/a$h;->bH:I
    ...
    iput v0, p0, Landroid/support/design/widget/NavigationView;->iT:I
    ...
    .line 131
    :goto_0
    sget v1, Landroid/support/design/a$i;->cV:I
    ...
    .line 137
    sget v7, Landroid/support/design/a$i;->cT:I
    ...
    .line 138
    sget v5, Landroid/support/design/a$i;->cT:I
    ...
    .line 146
    :cond_2
    sget v7, Landroid/support/design/a$i;->cU:I
    ...
    .line 148
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->iQ:Landroid/support/design/internal/a;
    ...
    .line 157
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->iR:Landroid/support/design/internal/b;
    ...
    iget-object v9, p0, Landroid/support/design/widget/NavigationView;->iQ:Landroid/support/design/internal/a;
    ...
    .line 161
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iR:Landroid/support/design/internal/b;
    ...
    .line 165
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iQ:Landroid/support/design/internal/a;

    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->iR:Landroid/support/design/internal/b;
    ...
    iget-object v0, v1, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;

    iget-object v0, v1, Landroid/support/design/internal/b;->ee:Landroid/support/design/internal/b$b;
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->ee:Landroid/support/design/internal/b$b;

    :cond_4
    iget-object v0, v1, Landroid/support/design/internal/b;->mLayoutInflater:Landroid/view/LayoutInflater;

    sget v3, Landroid/support/design/a$f;->bu:I

    iget-object v5, v1, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->eb:Landroid/widget/LinearLayout;

    iget-object v0, v1, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;

    iget-object v3, v1, Landroid/support/design/internal/b;->ee:Landroid/support/design/internal/b$b;
    ...
    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->iU:Landroid/view/MenuInflater;
    ...
    iput-object v1, p0, Landroid/support/design/widget/NavigationView;->iU:Landroid/view/MenuInflater;

    :cond_6
    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->iU:Landroid/view/MenuInflater;

    iget-object v3, p0, Landroid/support/design/widget/NavigationView;->iQ:Landroid/support/design/internal/a;
    ...
    iget-object v4, v1, Landroid/support/design/internal/b;->eb:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v0, v4, v2}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object v0

    iget-object v3, v1, Landroid/support/design/internal/b;->eb:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v0}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, v1, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;

    iget-object v1, v1, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;
...
.method private F(I)Landroid/content/res/ColorStateList;
    ...
    sget-object v5, Landroid/support/design/widget/NavigationView;->iP:[I

    aput-object v5, v4, v8

    sget-object v5, Landroid/support/design/widget/NavigationView;->dU:[I
    ...
    sget-object v6, Landroid/support/design/widget/NavigationView;->iP:[I
...
.method static synthetic a(Landroid/support/design/widget/NavigationView;)Landroid/support/design/widget/NavigationView$a;
    ...
    .prologue
    .line 75
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iS:Landroid/support/design/widget/NavigationView$a;
...
.method protected final a(Landroid/graphics/Rect;)V
    ...
    iget v2, v0, Landroid/support/design/internal/b;->ej:I

    if-eq v2, v1, :cond_0

    iput v1, v0, Landroid/support/design/internal/b;->ej:I

    iget-object v1, v0, Landroid/support/design/internal/b;->eb:Landroid/widget/LinearLayout;
    ...
    iget-object v1, v0, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;

    iget v2, v0, Landroid/support/design/internal/b;->ej:I

    iget-object v0, v0, Landroid/support/design/internal/b;->ea:Landroid/support/design/internal/NavigationMenuView;
...
.method protected onMeasure(II)V
    ...
    iget v1, p0, Landroid/support/design/widget/NavigationView;->iT:I
    ...
    .line 219
    :sswitch_2
    iget v0, p0, Landroid/support/design/widget/NavigationView;->iT:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 196
    iget-object v2, p0, Landroid/support/design/widget/NavigationView;->iQ:Landroid/support/design/internal/a;

    iget-object v0, p1, Landroid/support/design/widget/NavigationView$SavedState;->iW:Landroid/os/Bundle;
    ...
    iget-object v0, v2, Landroid/support/v7/view/menu/f;->Lt:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v1, v2, Landroid/support/v7/view/menu/f;->Lt:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/design/widget/NavigationView$SavedState;->iW:Landroid/os/Bundle;

    .line 184
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iQ:Landroid/support/design/internal/a;

    iget-object v2, v1, Landroid/support/design/widget/NavigationView$SavedState;->iW:Landroid/os/Bundle;
