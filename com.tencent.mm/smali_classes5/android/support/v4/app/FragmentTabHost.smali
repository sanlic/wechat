...
.field private qW:Landroid/support/v4/app/m;

.field private rd:Landroid/widget/TabHost$OnTabChangeListener;

.field private re:Landroid/support/v4/app/FragmentTabHost$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->jX:Ljava/util/ArrayList;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/q;)Landroid/support/v4/app/q;
    ...
    :goto_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->jX:Ljava/util/ArrayList;
    ...
    .line 336
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->re:Landroid/support/v4/app/FragmentTabHost$a;
    ...
    .line 338
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->qW:Landroid/support/v4/app/m;
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentTabHost$a;->pH:Landroid/support/v4/app/Fragment;
    ...
    .line 346
    iget-object v0, v1, Landroid/support/v4/app/FragmentTabHost$a;->pH:Landroid/support/v4/app/Fragment;
    ...
    iget-object v2, v1, Landroid/support/v4/app/FragmentTabHost$a;->rh:Ljava/lang/Class;

    invoke-virtual {v2}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, v1, Landroid/support/v4/app/FragmentTabHost$a;->ri:Landroid/os/Bundle;
    ...
    iput-object v0, v1, Landroid/support/v4/app/FragmentTabHost$a;->pH:Landroid/support/v4/app/Fragment;

    .line 349
    iget v0, p0, Landroid/support/v4/app/FragmentTabHost;->mContainerId:I

    iget-object v2, v1, Landroid/support/v4/app/FragmentTabHost$a;->pH:Landroid/support/v4/app/Fragment;
    ...
    :cond_4
    :goto_2
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->re:Landroid/support/v4/app/FragmentTabHost$a;
...
.method protected onAttachedToWindow()V
    ...
    .line 259
    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->qW:Landroid/support/v4/app/m;
    ...
    iput-object v4, v0, Landroid/support/v4/app/FragmentTabHost$a;->pH:Landroid/support/v4/app/Fragment;

    .line 260
    iget-object v4, v0, Landroid/support/v4/app/FragmentTabHost$a;->pH:Landroid/support/v4/app/Fragment;
    ...
    .line 265
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->re:Landroid/support/v4/app/FragmentTabHost$a;
    ...
    .line 270
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->qW:Landroid/support/v4/app/m;
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/FragmentTabHost;->rf:Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 309
    iget-object v0, p1, Landroid/support/v4/app/FragmentTabHost$SavedState;->rg:Ljava/lang/String;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/v4/app/FragmentTabHost$SavedState;->rg:Ljava/lang/String;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    .prologue
    .line 314
    iget-boolean v0, p0, Landroid/support/v4/app/FragmentTabHost;->rf:Z
    ...
    .line 320
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->rd:Landroid/widget/TabHost$OnTabChangeListener;
...
.method public setOnTabChangedListener(Landroid/widget/TabHost$OnTabChangeListener;)V
    ...
    .prologue
    .line 223
    iput-object p1, p0, Landroid/support/v4/app/FragmentTabHost;->rd:Landroid/widget/TabHost$OnTabChangeListener;
