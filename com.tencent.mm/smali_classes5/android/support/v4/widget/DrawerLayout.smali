...
# static fields
.field private static final BE:Z

.field private static final BF:Z

.field static final Ch:Landroid/support/v4/widget/DrawerLayout$c;

.field private static final yv:[I


# instance fields
.field private final BG:Landroid/support/v4/widget/DrawerLayout$b;
...
.field final BM:Landroid/support/v4/widget/u;

.field final BN:Landroid/support/v4/widget/u;

.field private final BO:Landroid/support/v4/widget/DrawerLayout$g;

.field private final BP:Landroid/support/v4/widget/DrawerLayout$g;
...
.field BZ:Ljava/lang/CharSequence;

.field Ca:Ljava/lang/CharSequence;

.field private Cb:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->yv:[I
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v4/widget/DrawerLayout;->BE:Z
    ...
    :goto_1
    sput-boolean v1, Landroid/support/v4/widget/DrawerLayout;->BF:Z
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->Ch:Landroid/support/v4/widget/DrawerLayout$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BG:Landroid/support/v4/widget/DrawerLayout$b;

    .line 191
    const/high16 v0, -0x67000000

    iput v0, p0, Landroid/support/v4/widget/DrawerLayout;->BJ:I
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BL:Landroid/graphics/Paint;

    .line 201
    iput-boolean v4, p0, Landroid/support/v4/widget/DrawerLayout;->zf:Z

    .line 203
    iput v3, p0, Landroid/support/v4/widget/DrawerLayout;->BR:I

    .line 204
    iput v3, p0, Landroid/support/v4/widget/DrawerLayout;->BS:I

    .line 205
    iput v3, p0, Landroid/support/v4/widget/DrawerLayout;->BT:I

    .line 206
    iput v3, p0, Landroid/support/v4/widget/DrawerLayout;->BU:I

    .line 228
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->Cc:Landroid/graphics/drawable/Drawable;

    .line 229
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->Cd:Landroid/graphics/drawable/Drawable;

    .line 230
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->Ce:Landroid/graphics/drawable/Drawable;

    .line 231
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->Cf:Landroid/graphics/drawable/Drawable;
    ...
    iput v1, p0, Landroid/support/v4/widget/DrawerLayout;->BI:I
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BO:Landroid/support/v4/widget/DrawerLayout$g;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BP:Landroid/support/v4/widget/DrawerLayout$g;

    .line 375
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BO:Landroid/support/v4/widget/DrawerLayout$g;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;

    .line 376
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;

    iput v4, v2, Landroid/support/v4/widget/u;->Fd:I

    .line 377
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;

    iput v1, v2, Landroid/support/v4/widget/u;->Fb:F

    .line 378
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BO:Landroid/support/v4/widget/DrawerLayout$g;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;

    iput-object v3, v2, Landroid/support/v4/widget/DrawerLayout$g;->Cs:Landroid/support/v4/widget/u;

    .line 380
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BP:Landroid/support/v4/widget/DrawerLayout$g;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/u;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/u$a;)Landroid/support/v4/widget/u;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;

    .line 381
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;

    const/4 v3, 0x2

    iput v3, v2, Landroid/support/v4/widget/u;->Fd:I
    ...
    .line 383
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->BP:Landroid/support/v4/widget/DrawerLayout$g;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;

    iput-object v2, v1, Landroid/support/v4/widget/DrawerLayout$g;->Cs:Landroid/support/v4/widget/u;
    ...
    .line 394
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->Ch:Landroid/support/v4/widget/DrawerLayout$c;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->hv:Landroid/graphics/drawable/Drawable;
    ...
    iput v0, p0, Landroid/support/v4/widget/DrawerLayout;->BH:F
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->Cg:Ljava/util/ArrayList;
...
.method private ax(Landroid/view/View;)V
    ...
    .line 1591
    iget-boolean v1, p0, Landroid/support/v4/widget/DrawerLayout;->zf:Z
    ...
    .line 1600
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;
    ...
    .line 1602
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;
...
.method static synthetic bY()[I
    ...
    .prologue
    .line 94
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->yv:[I
...
.method private co()Landroid/view/View;
    .locals 5
...
.method static synthetic cq()Z
    ...
    .prologue
    .line 94
    sget-boolean v0, Landroid/support/v4/widget/DrawerLayout;->BE:Z
...
.method private p(II)V
    ...
    .line 614
    :sswitch_0
    iput p1, p0, Landroid/support/v4/widget/DrawerLayout;->BR:I

    goto :goto_0

    .line 617
    :sswitch_1
    iput p1, p0, Landroid/support/v4/widget/DrawerLayout;->BS:I

    goto :goto_0

    .line 620
    :sswitch_2
    iput p1, p0, Landroid/support/v4/widget/DrawerLayout;->BT:I

    goto :goto_0

    .line 623
    :sswitch_3
    iput p1, p0, Landroid/support/v4/widget/DrawerLayout;->BU:I
...
.method private s(Z)V
    ...
    .line 1562
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;
    ...
    .line 1565
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;
    ...
    .line 1572
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BO:Landroid/support/v4/widget/DrawerLayout$g;

    invoke-virtual {v0}, Landroid/support/v4/widget/DrawerLayout$g;->cn()V

    .line 1573
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BP:Landroid/support/v4/widget/DrawerLayout$g;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 1785
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->Cg:Ljava/util/ArrayList;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1917
    invoke-direct {p0}, Landroid/support/v4/widget/DrawerLayout;->co()Landroid/view/View;
    ...
    .line 1933
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BG:Landroid/support/v4/widget/DrawerLayout$b;
...
.method public final as(Landroid/view/View;)I
    ...
    :sswitch_0
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->BR:I
    ...
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->BT:I
    ...
    :cond_3
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->BU:I

    goto :goto_1

    :sswitch_1
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->BS:I
...
.method public computeScroll()V
    ...
    .line 1271
    :cond_0
    iput v2, p0, Landroid/support/v4/widget/DrawerLayout;->BK:F

    .line 1274
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;

    invoke-virtual {v0}, Landroid/support/v4/widget/u;->cL()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;

    invoke-virtual {v1}, Landroid/support/v4/widget/u;->cL()Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1376
    iget v2, p0, Landroid/support/v4/widget/DrawerLayout;->BK:F
    ...
    .line 1377
    iget v2, p0, Landroid/support/v4/widget/DrawerLayout;->BJ:I
    ...
    iget v3, p0, Landroid/support/v4/widget/DrawerLayout;->BK:F
    ...
    iget v3, p0, Landroid/support/v4/widget/DrawerLayout;->BJ:I
    ...
    .line 1380
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->BL:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->BL:Landroid/graphics/Paint;
    ...
    .line 1383
    :cond_8
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BX:Landroid/graphics/drawable/Drawable;
    ...
    iget v2, v2, Landroid/support/v4/widget/u;->Fc:I
    ...
    .line 1390
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->BX:Landroid/graphics/drawable/Drawable;
    ...
    .line 1394
    :cond_9
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BY:Landroid/graphics/drawable/Drawable;
    ...
    .line 1399
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;

    iget v3, v3, Landroid/support/v4/widget/u;->Fc:I
    ...
    .line 1402
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->BY:Landroid/graphics/drawable/Drawable;
...
.method final i(Landroid/view/View;F)V
    ...
    .line 916
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->eJ:Ljava/util/List;
...
.method public final k(Ljava/lang/Object;Z)V
    ...
    .prologue
    .line 439
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->Cb:Ljava/lang/Object;

    .line 440
    iput-boolean p2, p0, Landroid/support/v4/widget/DrawerLayout;->hu:Z
...
.method protected onAttachedToWindow()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/DrawerLayout;->zf:Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1337
    iget-boolean v0, p0, Landroid/support/v4/widget/DrawerLayout;->hu:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->hv:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    .line 1338
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->Ch:Landroid/support/v4/widget/DrawerLayout$c;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->Cb:Ljava/lang/Object;
    ...
    .line 1340
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->hv:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->BN:Landroid/support/v4/widget/u;
    ...
    iget-boolean v0, p0, Landroid/support/v4/widget/DrawerLayout;->BW:Z
    ...
    .line 1443
    iput v0, p0, Landroid/support/v4/widget/DrawerLayout;->xL:F

    .line 1444
    iput v3, p0, Landroid/support/v4/widget/DrawerLayout;->xM:F

    .line 1445
    iget v5, p0, Landroid/support/v4/widget/DrawerLayout;->BK:F
    ...
    .line 1446
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;
    ...
    .line 1451
    :goto_4
    iput-boolean v2, p0, Landroid/support/v4/widget/DrawerLayout;->BV:Z

    .line 1452
    iput-boolean v2, p0, Landroid/support/v4/widget/DrawerLayout;->BW:Z
    ...
    iget-object v0, v5, Landroid/support/v4/widget/u;->ES:[F
    ...
    iget-object v3, v5, Landroid/support/v4/widget/u;->EU:[F

    aget v3, v3, v0

    iget-object v7, v5, Landroid/support/v4/widget/u;->ES:[F

    aget v7, v7, v0

    sub-float/2addr v3, v7

    iget-object v7, v5, Landroid/support/v4/widget/u;->EV:[F

    aget v7, v7, v0

    iget-object v8, v5, Landroid/support/v4/widget/u;->ET:[F
    ...
    iget v7, v5, Landroid/support/v4/widget/u;->iJ:I

    iget v8, v5, Landroid/support/v4/widget/u;->iJ:I
    ...
    .line 1467
    :pswitch_2
    invoke-direct {p0, v1}, Landroid/support/v4/widget/DrawerLayout;->s(Z)V
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    .line 1846
    invoke-direct {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->s(Z)V
...
.method protected onMeasure(II)V
    ...
    .line 1043
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->Cb:Ljava/lang/Object;
    ...
    .line 1063
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->Ch:Landroid/support/v4/widget/DrawerLayout$c;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->Cb:Ljava/lang/Object;
    ...
    .line 1077
    sget-boolean v6, Landroid/support/v4/widget/DrawerLayout;->BF:Z
    ...
    iget v11, p0, Landroid/support/v4/widget/DrawerLayout;->BH:F
    ...
    .line 1079
    iget v6, p0, Landroid/support/v4/widget/DrawerLayout;->BH:F
    ...
    .line 1098
    :goto_7
    iget v6, p0, Landroid/support/v4/widget/DrawerLayout;->BI:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1863
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$SavedState;->Cm:I
    ...
    .line 1870
    :cond_2
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$SavedState;->Cn:I
    ...
    .line 1873
    :cond_3
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$SavedState;->Co:I
    ...
    .line 1876
    :cond_4
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$SavedState;->Cp:I
...
.method public onRtlPropertiesChanged(I)V
    ...
    .prologue
    .line 1331
    sget-boolean v0, Landroid/support/v4/widget/DrawerLayout;->BF:Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->Cc:Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BX:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->Cd:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->Cd:Landroid/graphics/drawable/Drawable;

    :goto_1
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->BY:Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->Ce:Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->Cf:Landroid/graphics/drawable/Drawable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$SavedState;->Cm:I

    .line 1905
    :cond_1
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->BR:I

    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$SavedState;->Cn:I

    .line 1906
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->BS:I

    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$SavedState;->Co:I

    .line 1907
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->BT:I

    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$SavedState;->Cp:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1499
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->BM:Landroid/support/v4/widget/u;
    ...
    .line 1501
    iget v4, p0, Landroid/support/v4/widget/DrawerLayout;->xL:F

    sub-float/2addr v0, v4

    .line 1502
    iget v4, p0, Landroid/support/v4/widget/DrawerLayout;->xM:F
    ...
    iget v4, v4, Landroid/support/v4/widget/u;->iJ:I
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    .line 1535
    iput-boolean p1, p0, Landroid/support/v4/widget/DrawerLayout;->BV:Z
