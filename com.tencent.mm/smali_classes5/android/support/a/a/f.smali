...
# static fields
.field static final mk:Landroid/graphics/PorterDuff$Mode;


# instance fields
.field ml:Landroid/support/a/a/f$f;

.field private mm:Landroid/graphics/PorterDuffColorFilter;

.field private mn:Landroid/graphics/ColorFilter;

.field private mo:Z

.field mp:Z

.field private mq:Landroid/graphics/drawable/Drawable$ConstantState;

.field private final mr:[F

.field private final ms:Landroid/graphics/Matrix;

.field private final mt:Landroid/graphics/Rect;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/a/a/f;->mk:Landroid/graphics/PorterDuff$Mode;
...
.method private constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/support/a/a/f;->mp:Z
    ...
    iput-object v0, p0, Landroid/support/a/a/f;->mr:[F
    ...
    iput-object v0, p0, Landroid/support/a/a/f;->ms:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Landroid/support/a/a/f;->mt:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;
...
.method private constructor <init>(Landroid/support/a/a/f$f;)V
    ...
    .line 116
    iput-object p1, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;

    .line 117
    iget-object v0, p1, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;

    iget-object v1, p1, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v0, p0, Landroid/support/a/a/f;->mm:Landroid/graphics/PorterDuffColorFilter;
...
.method public static a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/a/a/f;
    ...
    :goto_0
    iput-object v0, v1, Landroid/support/a/a/f;->mj:Landroid/graphics/drawable/Drawable;

    .line 402
    new-instance v0, Landroid/support/a/a/f$g;

    iget-object v2, v1, Landroid/support/a/a/f;->mj:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, v1, Landroid/support/a/a/f;->mq:Landroid/graphics/drawable/Drawable$ConstantState;
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .prologue
    .line 568
    iget-object v4, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;

    .line 569
    iget-object v5, v4, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;
    ...
    .line 584
    sget-object v7, Landroid/support/a/a/a;->lS:[I
    ...
    .line 585
    iget-object v2, v2, Landroid/support/a/a/f$c;->mI:Ljava/util/ArrayList;

    invoke-virtual {v2, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 586
    iget-object v2, v3, Landroid/support/a/a/f$d;->mT:Ljava/lang/String;

    if-eqz v2, :cond_0

    .line 587
    iget-object v2, v5, Landroid/support/a/a/f$e;->ni:Landroid/support/v4/e/a;

    iget-object v7, v3, Landroid/support/a/a/f$d;->mT:Ljava/lang/String;
    ...
    .line 590
    iget v7, v4, Landroid/support/a/a/f$f;->ma:I

    iget v3, v3, Landroid/support/a/a/f$b;->ma:I

    or-int/2addr v3, v7

    iput v3, v4, Landroid/support/a/a/f$f;->ma:I
    ...
    sget-object v8, Landroid/support/a/a/a;->lT:[I
    ...
    .line 595
    iget-object v2, v7, Landroid/support/a/a/f$d;->mT:Ljava/lang/String;
    ...
    iget-object v8, v7, Landroid/support/a/a/f$d;->mT:Ljava/lang/String;

    invoke-virtual {v2, v8, v7}, Landroid/support/v4/e/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 598
    :cond_3
    iget v2, v4, Landroid/support/a/a/f$f;->ma:I

    iget v7, v7, Landroid/support/a/a/f$a;->ma:I

    or-int/2addr v2, v7

    iput v2, v4, Landroid/support/a/a/f$f;->ma:I
    ...
    .line 601
    sget-object v8, Landroid/support/a/a/a;->lR:[I
    ...
    iput-object v9, v7, Landroid/support/a/a/f$c;->mu:[I

    const-string/jumbo v9, "rotation"

    const/4 v10, 0x5

    iget v11, v7, Landroid/support/a/a/f$c;->mJ:F
    ...
    iput v9, v7, Landroid/support/a/a/f$c;->mJ:F

    const/4 v9, 0x1

    iget v10, v7, Landroid/support/a/a/f$c;->mK:F

    invoke-virtual {v8, v9, v10}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v9

    iput v9, v7, Landroid/support/a/a/f$c;->mK:F

    const/4 v9, 0x2

    iget v10, v7, Landroid/support/a/a/f$c;->mL:F

    invoke-virtual {v8, v9, v10}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v9

    iput v9, v7, Landroid/support/a/a/f$c;->mL:F

    const-string/jumbo v9, "scaleX"

    const/4 v10, 0x3

    iget v11, v7, Landroid/support/a/a/f$c;->mM:F
    ...
    iput v9, v7, Landroid/support/a/a/f$c;->mM:F
    ...
    iput-object v9, v7, Landroid/support/a/a/f$c;->mR:Ljava/lang/String;

    :cond_5
    iget-object v9, v7, Landroid/support/a/a/f$c;->mQ:Landroid/graphics/Matrix;
    ...
    iget v11, v7, Landroid/support/a/a/f$c;->mL:F
    ...
    iget v10, v7, Landroid/support/a/a/f$c;->mM:F
    ...
    iget v10, v7, Landroid/support/a/a/f$c;->mJ:F
    ...
    iget v11, v7, Landroid/support/a/a/f$c;->mK:F

    add-float/2addr v10, v11

    iget v11, v7, Landroid/support/a/a/f$c;->mP:F

    iget v12, v7, Landroid/support/a/a/f$c;->mL:F
    ...
    .line 604
    iget-object v2, v7, Landroid/support/a/a/f$c;->mR:Ljava/lang/String;
    ...
    iget-object v8, v7, Landroid/support/a/a/f$c;->mR:Ljava/lang/String;
    ...
    iget v7, v7, Landroid/support/a/a/f$c;->ma:I
...
.method public final canApplyTheme()Z
    ...
    .prologue
    .line 358
    iget-object v0, p0, Landroid/support/a/a/f;->mj:Landroid/graphics/drawable/Drawable;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    .line 156
    :cond_1
    iget-object v0, p0, Landroid/support/a/a/f;->mt:Landroid/graphics/Rect;
    ...
    .line 163
    iget-object v0, p0, Landroid/support/a/a/f;->mn:Landroid/graphics/ColorFilter;

    if-nez v0, :cond_6

    iget-object v0, p0, Landroid/support/a/a/f;->mm:Landroid/graphics/PorterDuffColorFilter;

    .line 169
    :goto_1
    iget-object v1, p0, Landroid/support/a/a/f;->ms:Landroid/graphics/Matrix;
    ...
    iget-object v3, p0, Landroid/support/a/a/f;->mr:[F

    invoke-virtual {v1, v3}, Landroid/graphics/Matrix;->getValues([F)V

    .line 171
    iget-object v1, p0, Landroid/support/a/a/f;->mr:[F
    ...
    .line 174
    iget-object v6, p0, Landroid/support/a/a/f;->mr:[F
    ...
    .line 175
    iget-object v7, p0, Landroid/support/a/a/f;->mr:[F
    ...
    .line 183
    :goto_2
    iget-object v3, p0, Landroid/support/a/a/f;->mt:Landroid/graphics/Rect;
    ...
    .line 193
    iget-object v1, p0, Landroid/support/a/a/f;->mt:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v7, p0, Landroid/support/a/a/f;->mt:Landroid/graphics/Rect;
    ...
    .line 207
    iget-object v7, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;

    iget-object v1, v7, Landroid/support/a/a/f$f;->nn:Landroid/graphics/Bitmap;
    ...
    iput-object v1, v7, Landroid/support/a/a/f$f;->nn:Landroid/graphics/Bitmap;

    iput-boolean v4, v7, Landroid/support/a/a/f$f;->ns:Z

    .line 208
    :cond_4
    iget-boolean v1, p0, Landroid/support/a/a/f;->mp:Z

    if-nez v1, :cond_8

    .line 209
    iget-object v1, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;
    ...
    :cond_5
    :goto_4
    iget-object v2, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;

    iget-object v3, p0, Landroid/support/a/a/f;->mt:Landroid/graphics/Rect;

    iget-object v1, v2, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;

    iget v1, v1, Landroid/support/a/a/f$e;->ng:I
    ...
    :goto_6
    iget-object v1, v2, Landroid/support/a/a/f$f;->nn:Landroid/graphics/Bitmap;
    ...
    iget-boolean v7, v1, Landroid/support/a/a/f$f;->ns:Z

    if-nez v7, :cond_9

    iget-object v7, v1, Landroid/support/a/a/f$f;->no:Landroid/content/res/ColorStateList;

    iget-object v8, v1, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;

    if-ne v7, v8, :cond_9

    iget-object v7, v1, Landroid/support/a/a/f$f;->np:Landroid/graphics/PorterDuff$Mode;

    iget-object v8, v1, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;

    if-ne v7, v8, :cond_9

    iget-boolean v7, v1, Landroid/support/a/a/f$f;->nr:Z

    iget-boolean v8, v1, Landroid/support/a/a/f$f;->nm:Z

    if-ne v7, v8, :cond_9

    iget v7, v1, Landroid/support/a/a/f$f;->nq:I

    iget-object v1, v1, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;
    ...
    iget-object v2, v1, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;

    iput-object v2, v1, Landroid/support/a/a/f$f;->no:Landroid/content/res/ColorStateList;

    iget-object v2, v1, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;

    iput-object v2, v1, Landroid/support/a/a/f$f;->np:Landroid/graphics/PorterDuff$Mode;

    iget-object v2, v1, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;

    iget v2, v2, Landroid/support/a/a/f$e;->ng:I

    iput v2, v1, Landroid/support/a/a/f$f;->nq:I

    iget-boolean v2, v1, Landroid/support/a/a/f$f;->nm:Z

    iput-boolean v2, v1, Landroid/support/a/a/f$f;->nr:Z

    iput-boolean v5, v1, Landroid/support/a/a/f$f;->ns:Z
    ...
    :cond_b
    iget-object v1, v2, Landroid/support/a/a/f$f;->nt:Landroid/graphics/Paint;
    ...
    iput-object v1, v2, Landroid/support/a/a/f$f;->nt:Landroid/graphics/Paint;
    ...
    iget-object v4, v2, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;

    iget v4, v4, Landroid/support/a/a/f$e;->ng:I
    ...
    iget-object v0, v2, Landroid/support/a/a/f$f;->nt:Landroid/graphics/Paint;
...
.method public final getAlpha()I
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;

    iget-object v0, v0, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;

    iget v0, v0, Landroid/support/a/a/f$e;->ng:I
...
.method public final getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    iget-object v1, p0, Landroid/support/a/a/f;->mj:Landroid/graphics/drawable/Drawable;
    ...
    iput v1, v0, Landroid/support/a/a/f$f;->ma:I
...
.method public final getIntrinsicHeight()I
    ...
    iget v0, v0, Landroid/support/a/a/f$e;->nd:F
...
.method public final getIntrinsicWidth()I
    ...
    iget v0, v0, Landroid/support/a/a/f$e;->nc:F
...
.method public final inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 467
    iput-object v0, v1, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;

    .line 469
    sget-object v0, Landroid/support/a/a/a;->lQ:[I
    ...
    .line 472
    iget-object v3, p0, Landroid/support/a/a/f;->ml:Landroid/support/a/a/f$f;

    iget-object v4, v3, Landroid/support/a/a/f$f;->nj:Landroid/support/a/a/f$e;
    ...
    :goto_1
    :pswitch_0
    iput-object v0, v3, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v0, v3, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;

    :cond_1
    const-string/jumbo v5, "autoMirrored"

    iget-boolean v0, v3, Landroid/support/a/a/f$f;->nm:Z
    ...
    :goto_2
    iput-boolean v0, v3, Landroid/support/a/a/f$f;->nm:Z

    const-string/jumbo v0, "viewportWidth"

    const/4 v3, 0x7

    iget v5, v4, Landroid/support/a/a/f$e;->ne:F
    ...
    iput v0, v4, Landroid/support/a/a/f$e;->ne:F

    const-string/jumbo v0, "viewportHeight"

    const/16 v3, 0x8

    iget v5, v4, Landroid/support/a/a/f$e;->nf:F

    invoke-static {v2, p2, v0, v3, v5}, Landroid/support/a/a/d;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v0

    iput v0, v4, Landroid/support/a/a/f$e;->nf:F

    iget v0, v4, Landroid/support/a/a/f$e;->ne:F
    ...
    :cond_3
    iget v0, v4, Landroid/support/a/a/f$e;->nf:F
    ...
    iget v3, v4, Landroid/support/a/a/f$e;->nc:F

    invoke-virtual {v2, v0, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, Landroid/support/a/a/f$e;->nc:F

    const/4 v0, 0x2

    iget v3, v4, Landroid/support/a/a/f$e;->nd:F

    invoke-virtual {v2, v0, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, Landroid/support/a/a/f$e;->nd:F

    iget v0, v4, Landroid/support/a/a/f$e;->nc:F
    ...
    :cond_5
    iget v0, v4, Landroid/support/a/a/f$e;->nd:F
    ...
    iget v5, v4, Landroid/support/a/a/f$e;->ng:I
    ...
    iput v0, v4, Landroid/support/a/a/f$e;->ng:I
    ...
    iput-object v0, v4, Landroid/support/a/a/f$e;->nh:Ljava/lang/String;

    iget-object v3, v4, Landroid/support/a/a/f$e;->ni:Landroid/support/v4/e/a;
    ...
    iput v0, v1, Landroid/support/a/a/f$f;->ma:I

    .line 475
    iput-boolean v8, v1, Landroid/support/a/a/f$f;->ns:Z
    ...
    .line 478
    iget-object v0, v1, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;

    iget-object v1, v1, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;
...
.method public final isStateful()Z
    ...
    iget-object v0, v0, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;
...
.method public final mutate()Landroid/graphics/drawable/Drawable;
    ...
    .line 127
    :cond_1
    iget-boolean v0, p0, Landroid/support/a/a/f;->mo:Z
    ...
    iput-boolean v0, p0, Landroid/support/a/a/f;->mo:Z
...
.method protected final onStateChange([I)Z
    ...
    .line 321
    iget-object v1, v0, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;

    if-eqz v1, :cond_1

    iget-object v1, v0, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;
...
.method public final setAlpha(I)V
    ...
    iput p1, v0, Landroid/support/a/a/f$e;->ng:I
...
.method public final setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    .line 248
    :cond_0
    iput-object p1, p0, Landroid/support/a/a/f;->mn:Landroid/graphics/ColorFilter;
...
.method public final setTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 284
    iput-object p1, v0, Landroid/support/a/a/f$f;->nk:Landroid/content/res/ColorStateList;
...
.method public final setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 298
    iput-object p1, v0, Landroid/support/a/a/f$f;->nl:Landroid/graphics/PorterDuff$Mode;
