...
.method private constructor <init>(II)V
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vy:I

    .line 9773
    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vz:Z

    .line 9777
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$p$a;->VA:I

    .line 9804
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vw:I

    .line 9805
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vx:I
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView$p$a;Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 9759
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vy:I
    ...
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vy:I

    invoke-static {p1, v0}, Landroid/support/v7/widget/RecyclerView;->d(Landroid/support/v7/widget/RecyclerView;I)V

    iput-boolean v5, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vz:Z

    :goto_0
    return-void

    :cond_0
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vz:Z
    ...
    iget v1, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vw:I

    iget v2, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vx:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/RecyclerView$s;->smoothScrollBy(II)V

    :goto_1
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$p$a;->VA:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Landroid/support/v7/widget/RecyclerView$p$a;->VA:I
    ...
    :cond_5
    iput v5, p0, Landroid/support/v7/widget/RecyclerView$p$a;->VA:I
...
.method public final a(IIILandroid/view/animation/Interpolator;)V
    ...
    .prologue
    .line 9925
    iput p1, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vw:I

    .line 9926
    iput p2, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vx:I
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$p$a;->Vz:Z
