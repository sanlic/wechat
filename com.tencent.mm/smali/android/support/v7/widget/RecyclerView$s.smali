...
.field iG:Landroid/support/v4/widget/q;
...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 4026
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 4021
    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$s;->VO:Z

    .line 4024
    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$s;->VP:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$s;->iG:Landroid/support/v4/widget/q;
...
.method public final b(IIILandroid/view/animation/Interpolator;)V
    ...
    .line 4217
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 4220
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$s;->VN:I

    iput v1, p0, Landroid/support/v7/widget/RecyclerView$s;->VM:I

    .line 4221
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$s;->iG:Landroid/support/v4/widget/q;
...
.method final fY()V
    ...
    .prologue
    .line 4158
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$s;->VO:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$s;->VP:Z
...
.method public final run()V
    ...
    iget-object v1, v0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$s;->VP:Z

    const/4 v1, 0x1

    move-object/from16 v0, p0

    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$s;->VO:Z
    ...
    iget-object v8, v0, Landroid/support/v7/widget/RecyclerView$s;->iG:Landroid/support/v4/widget/q;
    ...
    iget-object v9, v1, Landroid/support/v7/widget/RecyclerView$h;->UX:Landroid/support/v7/widget/RecyclerView$p;
    ...
    iget v1, v0, Landroid/support/v7/widget/RecyclerView$s;->VM:I
    ...
    iget v1, v0, Landroid/support/v7/widget/RecyclerView$s;->VN:I
    ...
    iput v10, v0, Landroid/support/v7/widget/RecyclerView$s;->VM:I

    .line 4050
    move-object/from16 v0, p0

    iput v11, v0, Landroid/support/v7/widget/RecyclerView$s;->VN:I
    ...
    iget-object v5, v0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;

    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;

    move-object/from16 v0, p0

    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/RecyclerView;->Q(Z)V

    .line 4070
    if-eqz v9, :cond_1a

    iget-boolean v5, v9, Landroid/support/v7/widget/RecyclerView$p;->Vs:Z

    if-nez v5, :cond_1a

    iget-boolean v5, v9, Landroid/support/v7/widget/RecyclerView$p;->Vt:Z
    ...
    iget-object v14, v5, Landroid/support/v7/widget/RecyclerView;->Uj:Landroid/support/v4/widget/i;
    ...
    iget-object v14, v5, Landroid/support/v7/widget/RecyclerView;->Uk:Landroid/support/v4/widget/i;
    ...
    invoke-virtual {v1, v4, v3}, Landroid/support/v7/widget/RecyclerView;->S(II)V
    ...
    .line 4135
    iget-boolean v1, v9, Landroid/support/v7/widget/RecyclerView$p;->Vs:Z
    ...
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$s;->VP:Z
    ...
    .line 4075
    :cond_18
    iget v6, v9, Landroid/support/v7/widget/RecyclerView$p;->Vr:I
    ...
    iput v5, v9, Landroid/support/v7/widget/RecyclerView$p;->Vr:I
    ...
    iget-object v14, v5, Landroid/support/v7/widget/RecyclerView;->Ul:Landroid/support/v4/widget/i;
    ...
    iget-object v14, v5, Landroid/support/v7/widget/RecyclerView;->Um:Landroid/support/v4/widget/i;
...
.method public final smoothScrollBy(II)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;
