...
# static fields
.field private static final aaZ:Landroid/support/v7/widget/a/b;

.field private static final aba:Landroid/view/animation/Interpolator;

.field private static final abb:Landroid/view/animation/Interpolator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/a/a$a;->aba:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, Landroid/support/v7/widget/a/a$a;->abb:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, Landroid/support/v7/widget/a/a$a;->aaZ:Landroid/support/v7/widget/a/b;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v7/widget/a/a$a;->abc:I
...
.method public static a(Landroid/support/v7/widget/RecyclerView$t;Ljava/util/List;II)Landroid/support/v7/widget/RecyclerView$t;
    ...
    iget-object v10, v0, Landroid/support/v7/widget/RecyclerView$t;->VQ:Landroid/view/View;

    invoke-virtual {v10}, Landroid/view/View;->getRight()I

    move-result v10

    iget-object v11, p0, Landroid/support/v7/widget/RecyclerView$t;->VQ:Landroid/view/View;
...
.method private static a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$t;FFI)V
    ...
    .prologue
    .line 2072
    sget-object v0, Landroid/support/v7/widget/a/a$a;->aaZ:Landroid/support/v7/widget/a/b;

    iget-object v3, p2, Landroid/support/v7/widget/RecyclerView$t;->VQ:Landroid/view/View;
...
.method static synthetic a(Landroid/support/v7/widget/a/a$a;Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$t;Ljava/util/List;IFF)V
    ...
    iget v4, v0, Landroid/support/v7/widget/a/a$c;->abl:F

    iget v5, v0, Landroid/support/v7/widget/a/a$c;->aaJ:I
    ...
    iget-boolean v3, v0, Landroid/support/v7/widget/a/a$c;->oL:Z

    if-eqz v3, :cond_2

    iget-boolean v3, v0, Landroid/support/v7/widget/a/a$c;->abj:Z
    ...
    :cond_2
    iget-boolean v0, v0, Landroid/support/v7/widget/a/a$c;->oL:Z
...
.method static synthetic b(Landroid/support/v7/widget/a/a$a;Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$t;Ljava/util/List;IFF)V
    ...
    iget v1, v0, Landroid/support/v7/widget/a/a$c;->abd:F

    iget v2, v0, Landroid/support/v7/widget/a/a$c;->abf:F
    ...
    iput v1, v0, Landroid/support/v7/widget/a/a$c;->abk:F

    :goto_1
    iget v1, v0, Landroid/support/v7/widget/a/a$c;->abe:F

    iget v2, v0, Landroid/support/v7/widget/a/a$c;->abg:F
    ...
    iput v1, v0, Landroid/support/v7/widget/a/a$c;->abl:F
    ...
    iget-object v3, v0, Landroid/support/v7/widget/a/a$c;->Vd:Landroid/support/v7/widget/RecyclerView$t;

    iget v4, v0, Landroid/support/v7/widget/a/a$c;->abk:F

    iget v5, v0, Landroid/support/v7/widget/a/a$c;->abl:F

    iget v6, v0, Landroid/support/v7/widget/a/a$c;->aaJ:I
    ...
    iget v2, v0, Landroid/support/v7/widget/a/a$c;->oJ:F

    iget v3, v0, Landroid/support/v7/widget/a/a$c;->abf:F

    iget v4, v0, Landroid/support/v7/widget/a/a$c;->abd:F
    ...
    iget v3, v0, Landroid/support/v7/widget/a/a$c;->abg:F

    iget v4, v0, Landroid/support/v7/widget/a/a$c;->abe:F
...
.method public static f(Landroid/support/v7/widget/RecyclerView;I)J
    ...
    iget-wide v0, v0, Landroid/support/v7/widget/RecyclerView$e;->UT:J

    goto :goto_0

    :cond_2
    iget-wide v0, v0, Landroid/support/v7/widget/RecyclerView$e;->US:J
...
.method public final a(Landroid/support/v7/widget/RecyclerView;IIJ)I
    ...
    .line 2131
    iget v2, p0, Landroid/support/v7/widget/a/a$a;->abc:I
    ...
    sget v3, Landroid/support/v7/d/a$a;->Jk:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    iput v2, p0, Landroid/support/v7/widget/a/a$a;->abc:I
    ...
    sget-object v4, Landroid/support/v7/widget/a/a$a;->abb:Landroid/view/animation/Interpolator;
    ...
    sget-object v3, Landroid/support/v7/widget/a/a$a;->aba:Landroid/view/animation/Interpolator;
...
.method public a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$t;FFIZ)V
    ...
    iget-object v3, p3, Landroid/support/v7/widget/RecyclerView$t;->VQ:Landroid/view/View;
