...
.field public Ku:Landroid/support/v7/view/menu/f$b;

.field private Kv:Landroid/support/v7/widget/ListPopupWindow$b;

.field public Kw:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kx:Z
    ...
    iput v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kz:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KB:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KA:I
...
.method static synthetic a(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/ActionMenuItemView$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kw:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method static synthetic b(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/f$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Ku:Landroid/support/v7/view/menu/f$b;
...
.method static synthetic c(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/h;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dY:Landroid/support/v7/view/menu/h;
...
.method private dm()V
    ...
    .line 173
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->uQ:Ljava/lang/CharSequence;
    ...
    .line 174
    :goto_0
    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jU:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dY:Landroid/support/v7/view/menu/h;

    iget v3, v3, Landroid/support/v7/view/menu/h;->LB:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kx:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Ky:Z
...
.method public final a(Landroid/support/v7/view/menu/h;)V
    ...
    .line 112
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dY:Landroid/support/v7/view/menu/h;
    ...
    iput-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jU:Landroid/graphics/drawable/Drawable;
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KB:I
    ...
    iget v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KB:I
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KB:I
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->dm()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->uQ:Ljava/lang/CharSequence;
    ...
    .line 121
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kv:Landroid/support/v7/widget/ListPopupWindow$b;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kv:Landroid/support/v7/widget/ListPopupWindow$b;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dY:Landroid/support/v7/view/menu/h;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kx:Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 250
    :cond_1
    iget-object v8, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dY:Landroid/support/v7/view/menu/h;
...
.method protected onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KA:I
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kz:I
    ...
    iget v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kz:I
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jU:Landroid/graphics/drawable/Drawable;
    ...
    .line 289
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jU:Landroid/graphics/drawable/Drawable;
    ...
    .line 276
    :cond_3
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kz:I
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 103
    iput p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KA:I
