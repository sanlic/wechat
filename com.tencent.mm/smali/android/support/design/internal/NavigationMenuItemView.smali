...
.field final dW:Landroid/widget/CheckedTextView;

.field dX:Landroid/widget/FrameLayout;

.field dY:Landroid/support/v7/view/menu/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/internal/NavigationMenuItemView;->dU:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v1, Landroid/support/design/a$f;->by:I
    ...
    sget v1, Landroid/support/design/a$d;->bb:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dV:I

    .line 69
    sget v0, Landroid/support/design/a$e;->bj:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dW:Landroid/widget/CheckedTextView;

    .line 70
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dW:Landroid/widget/CheckedTextView;
...
.method public final B()Landroid/support/v7/view/menu/h;
    ...
    .prologue
    .line 122
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dY:Landroid/support/v7/view/menu/h;
...
.method public final a(Landroid/support/v7/view/menu/h;)V
    ...
    .line 75
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dY:Landroid/support/v7/view/menu/h;
    ...
    sget-object v3, Landroid/support/design/internal/NavigationMenuItemView;->dU:[I
    ...
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dW:Landroid/widget/CheckedTextView;
    ...
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dX:Landroid/widget/FrameLayout;

    if-nez v0, :cond_1

    sget v0, Landroid/support/design/a$e;->bi:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dX:Landroid/widget/FrameLayout;
...
.method protected onCreateDrawableState(I)[I
    ...
    .line 169
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dY:Landroid/support/v7/view/menu/h;
    ...
    .line 170
    sget-object v1, Landroid/support/design/internal/NavigationMenuItemView;->dU:[I
...
.method public final setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 150
    iget v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dV:I

    iget v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dV:I

    invoke-virtual {p1, v2, v2, v0, v1}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 151
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dZ:Landroid/content/res/ColorStateList;
