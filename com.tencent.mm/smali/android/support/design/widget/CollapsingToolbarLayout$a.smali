...
# instance fields
.field final synthetic gW:Landroid/support/design/widget/CollapsingToolbarLayout;
...
.method private constructor <init>(Landroid/support/design/widget/CollapsingToolbarLayout;)V
    ...
    .prologue
    .line 1107
    iput-object p1, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gW:Landroid/support/design/widget/CollapsingToolbarLayout;
...
.method public final a(Landroid/support/design/widget/AppBarLayout;I)V
    ...
    .line 1110
    iget-object v0, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gW:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    .line 1120
    iget v10, v0, Landroid/support/design/widget/CollapsingToolbarLayout$LayoutParams;->gX:I
    ...
    iget v0, v0, Landroid/support/design/widget/CollapsingToolbarLayout$LayoutParams;->gY:F
    ...
    .line 1135
    :cond_3
    iget-object v5, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gW:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    iget-object v7, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gW:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    :goto_4
    iget-boolean v7, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gS:Z
    ...
    :cond_4
    invoke-virtual {v5}, Landroid/support/design/widget/CollapsingToolbarLayout;->R()V

    iget-object v3, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gT:Landroid/support/design/widget/u;
    ...
    iput-object v3, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gT:Landroid/support/design/widget/u;
    ...
    iget-object v4, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gT:Landroid/support/design/widget/u;

    iget v3, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gR:I

    if-le v2, v3, :cond_a

    sget-object v3, Landroid/support/design/widget/a;->ez:Landroid/view/animation/Interpolator;
    ...
    iget v4, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gR:I

    invoke-virtual {v3, v4, v2}, Landroid/support/design/widget/u;->g(II)V

    iget-object v2, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gT:Landroid/support/design/widget/u;
    ...
    :goto_7
    iput-boolean v0, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gS:Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gW:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    .line 1145
    iget-object v1, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gW:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    .line 1151
    iget v0, p1, Landroid/support/design/widget/AppBarLayout;->eG:F
    ...
    :cond_a
    sget-object v3, Landroid/support/design/widget/a;->eA:Landroid/view/animation/Interpolator;
    ...
    iget-object v3, v3, Landroid/support/design/widget/u;->lo:Landroid/support/design/widget/u$e;
