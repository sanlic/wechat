...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Loicq/wlogin_sdk/request/c;->zsB:Ljava/util/TreeMap;
...
.method private declared-synchronized b(Ljava/util/TreeMap;Ljava/lang/String;)I
    ...
    sget-object v1, Loicq/wlogin_sdk/request/i;->ztd:[B
...
.method private static bS(Landroid/content/Context;Ljava/lang/String;)Ljava/util/TreeMap;
    ...
    sget-object v3, Loicq/wlogin_sdk/request/i;->ztd:[B
    ...
    :goto_2
    :try_start_2
    invoke-static {p0}, Loicq/wlogin_sdk/tools/util;->iQ(Landroid/content/Context;)[B
    ...
    :cond_2
    :try_start_4
    invoke-static {p0}, Loicq/wlogin_sdk/tools/util;->iP(Landroid/content/Context;)[B
    ...
    :cond_4
    :try_start_6
    invoke-static {p0}, Loicq/wlogin_sdk/tools/util;->iO(Landroid/content/Context;)[B
...
.method private declared-synchronized fU(J)Loicq/wlogin_sdk/request/WloginAllSigInfo;
    .locals 5
    ...
    .line 98
    iget-object v0, p0, Loicq/wlogin_sdk/request/c;->zsB:Ljava/util/TreeMap;
    ...
    .line 124
    :cond_3
    iget-object v1, p0, Loicq/wlogin_sdk/request/c;->zsB:Ljava/util/TreeMap;
...
.method public final declared-synchronized K(JJ)Loicq/wlogin_sdk/sharemem/WloginSigInfo;
    ...
    .line 132
    invoke-direct {p0, p1, p2}, Loicq/wlogin_sdk/request/c;->fU(J)Loicq/wlogin_sdk/request/WloginAllSigInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(JJJJJJ[B[B[B[B[B[B[B[B[B[B[B[B[B[B[B[B[[B)I
    ...
    iget-object v2, v0, Loicq/wlogin_sdk/request/c;->zsB:Ljava/util/TreeMap;
