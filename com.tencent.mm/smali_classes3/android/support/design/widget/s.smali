...
# instance fields
.field private fh:Landroid/support/v4/widget/u;

.field private fi:Z

.field private final fu:Landroid/support/v4/widget/u$a;

.field jK:Landroid/support/design/widget/s$a;
...
.method public constructor <init>()V
    ...
    .line 85
    iput v1, p0, Landroid/support/design/widget/s;->jL:F

    .line 88
    const/4 v0, 0x2

    iput v0, p0, Landroid/support/design/widget/s;->jN:I

    .line 89
    iput v2, p0, Landroid/support/design/widget/s;->jO:F

    .line 90
    iput v1, p0, Landroid/support/design/widget/s;->jP:F

    .line 91
    iput v2, p0, Landroid/support/design/widget/s;->jQ:F
    ...
    iput-object v0, p0, Landroid/support/design/widget/s;->fu:Landroid/support/v4/widget/u$a;
...
.method static synthetic a(Landroid/support/design/widget/s;)Landroid/support/design/widget/s$a;
    ...
    .prologue
    .line 36
    iget-object v0, p0, Landroid/support/design/widget/s;->jK:Landroid/support/design/widget/s$a;
...
.method static synthetic b(Landroid/support/design/widget/s;)Landroid/support/v4/widget/u;
    ...
    .prologue
    .line 36
    iget-object v0, p0, Landroid/support/design/widget/s;->fh:Landroid/support/v4/widget/u;
...
.method static synthetic c(Landroid/support/design/widget/s;)I
    ...
    .prologue
    .line 36
    iget v0, p0, Landroid/support/design/widget/s;->jN:I
...
.method static synthetic d(Landroid/support/design/widget/s;)F
    ...
    .prologue
    .line 36
    iget v0, p0, Landroid/support/design/widget/s;->jO:F
...
.method static synthetic f(Landroid/support/design/widget/s;)F
    ...
    .prologue
    .line 36
    iget v0, p0, Landroid/support/design/widget/s;->jQ:F
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/design/widget/s;->fi:Z

    .line 186
    :cond_0
    iget-boolean v0, p0, Landroid/support/design/widget/s;->fi:Z
    ...
    .line 176
    iput-boolean v1, p0, Landroid/support/design/widget/s;->fi:Z
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/s;->jM:Z

    if-eqz v0, :cond_4

    iget v0, p0, Landroid/support/design/widget/s;->jL:F

    iget-object v1, p0, Landroid/support/design/widget/s;->fu:Landroid/support/v4/widget/u$a;
    ...
    :goto_2
    iput-object v0, p0, Landroid/support/design/widget/s;->fh:Landroid/support/v4/widget/u;
    ...
    .line 190
    :cond_4
    iget-object v0, p0, Landroid/support/design/widget/s;->fu:Landroid/support/v4/widget/u$a;
