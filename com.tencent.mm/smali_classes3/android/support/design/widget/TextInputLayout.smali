...
# instance fields
.field private eO:Landroid/support/design/widget/u;

.field private final gM:Landroid/support/design/widget/f;

.field private kP:Landroid/widget/EditText;

.field kQ:Z

.field kR:Ljava/lang/CharSequence;

.field private kS:Landroid/graphics/Paint;

.field private kT:Landroid/widget/LinearLayout;
...
.field private kZ:Ljava/lang/CharSequence;
...
.field private lg:Landroid/content/res/ColorStateList;

.field private lh:Landroid/content/res/ColorStateList;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->gM:Landroid/support/design/widget/f;
    ...
    .line 140
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->gM:Landroid/support/design/widget/f;

    sget-object v2, Landroid/support/design/widget/a;->ey:Landroid/view/animation/Interpolator;
    ...
    iput-object v2, v0, Landroid/support/design/widget/f;->gs:Landroid/view/animation/Interpolator;

    invoke-virtual {v0}, Landroid/support/design/widget/f;->P()V
    ...
    .line 144
    sget-object v0, Landroid/support/design/a$i;->dC:[I

    sget v2, Landroid/support/design/a$h;->bK:I
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/TextInputLayout;->kQ:Z

    .line 147
    sget v0, Landroid/support/design/a$i;->dE:I
    ...
    .line 151
    sget v0, Landroid/support/design/a$i;->dD:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->lh:Landroid/content/res/ColorStateList;

    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->lg:Landroid/content/res/ColorStateList;

    .line 156
    :cond_0
    sget v0, Landroid/support/design/a$i;->dF:I
    ...
    iget-object v3, p0, Landroid/support/design/widget/TextInputLayout;->gM:Landroid/support/design/widget/f;

    invoke-virtual {v3, v0}, Landroid/support/design/widget/f;->y(I)V

    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->gM:Landroid/support/design/widget/f;

    iget v0, v0, Landroid/support/design/widget/f;->fX:I
    ...
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kP:Landroid/widget/EditText;
    ...
    iget-object v3, p0, Landroid/support/design/widget/TextInputLayout;->kP:Landroid/widget/EditText;
    ...
    iput v0, p0, Landroid/support/design/widget/TextInputLayout;->kX:I
    ...
    iget v5, p0, Landroid/support/design/widget/TextInputLayout;->lc:I
    ...
    iput v0, p0, Landroid/support/design/widget/TextInputLayout;->ld:I
    ...
    iput v0, p0, Landroid/support/design/widget/TextInputLayout;->le:I
    ...
    iget v3, p0, Landroid/support/design/widget/TextInputLayout;->ld:I
    ...
    :goto_3
    iput-boolean v4, p0, Landroid/support/design/widget/TextInputLayout;->la:Z
    ...
    .line 168
    :cond_5
    iput v7, p0, Landroid/support/design/widget/TextInputLayout;->lc:I
    ...
    sget v3, Landroid/support/design/a$c;->aX:I
...
.method private L(I)V
    ...
    sget v5, Landroid/support/design/a$g;->bz:I
...
.method private a(Landroid/widget/TextView;)V
    ...
    .prologue
    .line 467
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kT:Landroid/widget/LinearLayout;
    ...
    .line 469
    iget v0, p0, Landroid/support/design/widget/TextInputLayout;->kU:I

    add-int/lit8 v0, v0, -0x1

    iput v0, p0, Landroid/support/design/widget/TextInputLayout;->kU:I
...
.method private a(Landroid/widget/TextView;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kT:Landroid/widget/LinearLayout;
    ...
    .line 449
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->kT:Landroid/widget/LinearLayout;
    ...
    .line 452
    invoke-direct {p0}, Landroid/support/design/widget/TextInputLayout;->av()V
...
.method private av()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->kP:Landroid/widget/EditText;
    ...
    iget-object v4, p0, Landroid/support/design/widget/TextInputLayout;->kP:Landroid/widget/EditText;
...
.method private aw()V
    ...
    .line 707
    :cond_5
    iget-boolean v1, p0, Landroid/support/design/widget/TextInputLayout;->kY:Z

    if-eqz v1, :cond_6

    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->kW:Landroid/widget/TextView;
...
.method private b(Landroid/view/ViewGroup$LayoutParams;)Landroid/widget/LinearLayout$LayoutParams;
    ...
    .line 286
    :goto_0
    iget-boolean v0, p0, Landroid/support/design/widget/TextInputLayout;->kQ:Z

    if-eqz v0, :cond_3

    .line 287
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kS:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kS:Landroid/graphics/Paint;

    .line 290
    :cond_0
    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->kS:Landroid/graphics/Paint;

    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->gM:Landroid/support/design/widget/f;

    iget-object v2, v0, Landroid/support/design/widget/f;->ge:Landroid/graphics/Typeface;

    if-eqz v2, :cond_2

    iget-object v0, v0, Landroid/support/design/widget/f;->ge:Landroid/graphics/Typeface;
    ...
    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->gM:Landroid/support/design/widget/f;

    iget v1, v1, Landroid/support/design/widget/f;->fV:F
...
.method static synthetic c(Landroid/support/design/widget/TextInputLayout;)Landroid/widget/TextView;
    ...
    .prologue
    .line 82
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kW:Landroid/widget/TextView;
...
.method private getError()Ljava/lang/CharSequence;
    ...
    .prologue
    .line 831
    iget-boolean v0, p0, Landroid/support/design/widget/TextInputLayout;->kV:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kZ:Ljava/lang/CharSequence;
...
.method private k(Z)V
    ...
    .line 305
    :goto_3
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->lg:Landroid/content/res/ColorStateList;

    if-eqz v2, :cond_0

    .line 306
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->gM:Landroid/support/design/widget/f;

    iget-object v4, p0, Landroid/support/design/widget/TextInputLayout;->lg:Landroid/content/res/ColorStateList;

    invoke-virtual {v4}, Landroid/content/res/ColorStateList;->getDefaultColor()I

    move-result v4

    iget v5, v2, Landroid/support/design/widget/f;->fW:I

    if-eq v5, v4, :cond_0

    iput v4, v2, Landroid/support/design/widget/f;->fW:I

    invoke-virtual {v2}, Landroid/support/design/widget/f;->P()V

    .line 309
    :cond_0
    iget-boolean v2, p0, Landroid/support/design/widget/TextInputLayout;->lf:Z

    if-eqz v2, :cond_8

    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->lb:Landroid/widget/TextView;
    ...
    .line 319
    :cond_2
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->eO:Landroid/support/design/widget/u;

    if-eqz v0, :cond_3

    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->eO:Landroid/support/design/widget/u;

    iget-object v0, v0, Landroid/support/design/widget/u;->lo:Landroid/support/design/widget/u$e;
    ...
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->lh:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, p0, Landroid/support/design/widget/TextInputLayout;->lh:Landroid/content/res/ColorStateList;
...
.method private l(Z)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kW:Landroid/widget/TextView;
    ...
    iget v2, p0, Landroid/support/design/widget/TextInputLayout;->kX:I
    ...
    .line 510
    :goto_1
    iput-boolean p1, p0, Landroid/support/design/widget/TextInputLayout;->kV:Z
    ...
    sget v2, Landroid/support/design/a$c;->aX:I
    ...
    .line 505
    :cond_2
    iput-boolean v3, p0, Landroid/support/design/widget/TextInputLayout;->kY:Z
...
.method private n(F)V
    ...
    iget v0, v0, Landroid/support/design/widget/f;->fO:F
    ...
    .line 922
    invoke-static {}, Landroid/support/design/widget/aa;->ay()Landroid/support/design/widget/u;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->eO:Landroid/support/design/widget/u;

    .line 923
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->eO:Landroid/support/design/widget/u;

    sget-object v1, Landroid/support/design/widget/a;->ex:Landroid/view/animation/Interpolator;
    ...
    iget v1, v1, Landroid/support/design/widget/f;->fO:F
...
.method private setHint(Ljava/lang/CharSequence;)V
    ...
    .line 343
    iput-object p1, p0, Landroid/support/design/widget/TextInputLayout;->kR:Ljava/lang/CharSequence;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    :cond_0
    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kP:Landroid/widget/EditText;
    ...
    iput-object v1, v0, Landroid/support/design/widget/f;->gf:Landroid/graphics/Typeface;

    iput-object v1, v0, Landroid/support/design/widget/f;->ge:Landroid/graphics/Typeface;
    ...
    iget v2, v0, Landroid/support/design/widget/f;->fU:F

    cmpl-float v2, v2, v1

    if-eqz v2, :cond_1

    iput v1, v0, Landroid/support/design/widget/f;->fU:F
    ...
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->lg:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->kR:Ljava/lang/CharSequence;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->kP:Landroid/widget/EditText;
    ...
    iget-object v5, p0, Landroid/support/design/widget/TextInputLayout;->kP:Landroid/widget/EditText;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 818
    iget-object v3, p1, Landroid/support/design/widget/TextInputLayout$SavedState;->lm:Ljava/lang/CharSequence;
    ...
    iput-object v3, p0, Landroid/support/design/widget/TextInputLayout;->kZ:Ljava/lang/CharSequence;
    ...
    :goto_1
    iput-boolean v0, p0, Landroid/support/design/widget/TextInputLayout;->kY:Z

    iget-boolean v0, p0, Landroid/support/design/widget/TextInputLayout;->kY:Z
    ...
    sget-object v2, Landroid/support/design/widget/a;->eA:Landroid/view/animation/Interpolator;
    ...
    sget-object v2, Landroid/support/design/widget/a;->ez:Landroid/view/animation/Interpolator;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/design/widget/TextInputLayout$SavedState;->lm:Ljava/lang/CharSequence;
