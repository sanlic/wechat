...
# instance fields
.field private dO:Landroid/graphics/drawable/Drawable;

.field private final dP:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dP:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dQ:Landroid/graphics/Rect;

    .line 41
    const/16 v0, 0x77

    iput v0, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dR:I

    .line 43
    iput-boolean v3, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dS:Z

    .line 45
    iput-boolean v1, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dT:Z

    .line 58
    sget-object v0, Landroid/support/design/a$i;->cI:[I
    ...
    iget v2, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dR:I

    invoke-virtual {v0, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dR:I
    ...
    .line 69
    :cond_0
    sget v1, Landroid/support/design/a$i;->cL:I

    invoke-virtual {v0, v1, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dS:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 194
    iget-object v0, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dO:Landroid/graphics/drawable/Drawable;
    ...
    .line 197
    iget-boolean v1, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dT:Z

    if-eqz v1, :cond_0

    .line 198
    iput-boolean v6, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dT:Z

    .line 199
    iget-object v1, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dP:Landroid/graphics/Rect;

    .line 200
    iget-object v2, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dQ:Landroid/graphics/Rect;
    ...
    .line 205
    iget-boolean v5, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dS:Z
    ...
    .line 212
    :goto_0
    iget v3, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dR:I
...
.method public getForegroundGravity()I
    ...
    .prologue
    .line 82
    iget v0, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dR:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 181
    iget-boolean v0, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dT:Z

    or-int/2addr v0, p1

    iput-boolean v0, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dT:Z
...
.method public setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 148
    :cond_0
    iput-object p1, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dO:Landroid/graphics/drawable/Drawable;
...
.method public setForegroundGravity(I)V
    ...
    .line 105
    iget-object v1, p0, Landroid/support/design/internal/ForegroundLinearLayout;->dO:Landroid/graphics/drawable/Drawable;
