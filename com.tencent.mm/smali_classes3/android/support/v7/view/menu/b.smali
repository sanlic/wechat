...
.field public KD:Landroid/content/Context;

.field protected KE:Landroid/view/LayoutInflater;

.field private KF:I

.field private KG:I

.field public KH:Landroid/support/v7/view/menu/m;

.field public ec:Landroid/support/v7/view/menu/l$a;

.field public ed:Landroid/support/v7/view/menu/f;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 58
    iput-object p1, p0, Landroid/support/v7/view/menu/b;->KD:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->KE:Landroid/view/LayoutInflater;

    .line 60
    iput p2, p0, Landroid/support/v7/view/menu/b;->KF:I

    .line 61
    iput p3, p0, Landroid/support/v7/view/menu/b;->KG:I
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 180
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->KE:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/view/menu/b;->KG:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/f;)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->DB:Landroid/view/LayoutInflater;

    .line 68
    iput-object p2, p0, Landroid/support/v7/view/menu/b;->ed:Landroid/support/v7/view/menu/f;
...
.method public a(Landroid/support/v7/view/menu/f;Z)V
    ...
    .prologue
    .line 206
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->ec:Landroid/support/v7/view/menu/l$a;
...
.method public c(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/m;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->KH:Landroid/support/v7/view/menu/m;
    ...
    iget v1, p0, Landroid/support/v7/view/menu/b;->KF:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->KH:Landroid/support/v7/view/menu/m;

    .line 75
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->KH:Landroid/support/v7/view/menu/m;

    iget-object v1, p0, Landroid/support/v7/view/menu/b;->ed:Landroid/support/v7/view/menu/f;
...
.method public f(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/f;->dB()V
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/view/menu/b;->KH:Landroid/support/v7/view/menu/m;
