...
# instance fields
.field private final DB:Landroid/view/LayoutInflater;

.field public KT:Z

.field private final LT:Landroid/support/v7/view/menu/k$a;
...
.field public LY:Landroid/support/v7/widget/ListPopupWindow;

.field private LZ:Landroid/view/ViewTreeObserver;

.field public Ly:Landroid/support/v7/view/menu/l$a;
...
.field private final ed:Landroid/support/v7/view/menu/f;

.field public hE:Landroid/view/View;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/support/v7/view/menu/k;->LS:I
...
.method private constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/f;Landroid/view/View;ZIB)V
    ...
    .line 77
    iput v2, p0, Landroid/support/v7/view/menu/k;->Md:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->DB:Landroid/view/LayoutInflater;

    .line 96
    iput-object p2, p0, Landroid/support/v7/view/menu/k;->ed:Landroid/support/v7/view/menu/f;

    .line 97
    new-instance v0, Landroid/support/v7/view/menu/k$a;

    iget-object v1, p0, Landroid/support/v7/view/menu/k;->ed:Landroid/support/v7/view/menu/f;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->LT:Landroid/support/v7/view/menu/k$a;

    .line 98
    iput-boolean p4, p0, Landroid/support/v7/view/menu/k;->LU:Z

    .line 99
    iput p5, p0, Landroid/support/v7/view/menu/k;->LW:I

    .line 100
    iput v2, p0, Landroid/support/v7/view/menu/k;->LX:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/k;->LV:I

    .line 106
    iput-object p3, p0, Landroid/support/v7/view/menu/k;->hE:Landroid/view/View;
...
.method static synthetic a(Landroid/support/v7/view/menu/k;)Z
    ...
    .prologue
    .line 45
    iget-boolean v0, p0, Landroid/support/v7/view/menu/k;->LU:Z
...
.method static synthetic b(Landroid/support/v7/view/menu/k;)Landroid/view/LayoutInflater;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->DB:Landroid/view/LayoutInflater;
...
.method static synthetic c(Landroid/support/v7/view/menu/k;)Landroid/support/v7/view/menu/f;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->ed:Landroid/support/v7/view/menu/f;
...
.method public final a(Landroid/support/v7/view/menu/f;Z)V
    ...
    .line 307
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Ly:Landroid/support/v7/view/menu/l$a;
...
.method public final a(Landroid/support/v7/view/menu/p;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/k;->hE:Landroid/view/View;
    ...
    iput-object v0, v3, Landroid/support/v7/view/menu/k;->Ly:Landroid/support/v7/view/menu/l$a;
    ...
    .line 289
    :goto_1
    iput-boolean v0, v3, Landroid/support/v7/view/menu/k;->KT:Z

    .line 291
    invoke-virtual {v3}, Landroid/support/v7/view/menu/k;->dM()Z
...
.method public final dM()Z
    ...
    iget v5, p0, Landroid/support/v7/view/menu/k;->LW:I

    iget v6, p0, Landroid/support/v7/view/menu/k;->LX:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->LY:Landroid/support/v7/widget/ListPopupWindow;

    .line 140
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->LY:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iput-object p0, v0, Landroid/support/v7/widget/ListPopupWindow;->SU:Landroid/widget/AdapterView$OnItemClickListener;

    .line 142
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->LY:Landroid/support/v7/widget/ListPopupWindow;

    iget-object v3, p0, Landroid/support/v7/view/menu/k;->LT:Landroid/support/v7/view/menu/k$a;
    ...
    .line 145
    iget-object v3, p0, Landroid/support/v7/view/menu/k;->hE:Landroid/view/View;

    .line 146
    if-eqz v3, :cond_5

    .line 147
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->LZ:Landroid/view/ViewTreeObserver;
    ...
    iput-object v5, p0, Landroid/support/v7/view/menu/k;->LZ:Landroid/view/ViewTreeObserver;
    ...
    iput-object v3, v0, Landroid/support/v7/widget/ListPopupWindow;->SS:Landroid/view/View;

    .line 151
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->LY:Landroid/support/v7/widget/ListPopupWindow;

    iget v3, p0, Landroid/support/v7/view/menu/k;->Md:I

    iput v3, v0, Landroid/support/v7/widget/ListPopupWindow;->Md:I

    .line 156
    iget-boolean v0, p0, Landroid/support/v7/view/menu/k;->Mb:Z

    if-nez v0, :cond_3

    .line 157
    iget-object v7, p0, Landroid/support/v7/view/menu/k;->LT:Landroid/support/v7/view/menu/k$a;
    ...
    :goto_2
    iget-object v5, p0, Landroid/support/v7/view/menu/k;->Ma:Landroid/view/ViewGroup;
    ...
    iput-object v5, p0, Landroid/support/v7/view/menu/k;->Ma:Landroid/view/ViewGroup;
    ...
    iget v11, p0, Landroid/support/v7/view/menu/k;->LV:I

    if-lt v0, v11, :cond_6

    iget v2, p0, Landroid/support/v7/view/menu/k;->LV:I

    :cond_2
    iput v2, p0, Landroid/support/v7/view/menu/k;->Mc:I

    .line 158
    iput-boolean v1, p0, Landroid/support/v7/view/menu/k;->Mb:Z

    .line 161
    :cond_3
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->LY:Landroid/support/v7/widget/ListPopupWindow;

    iget v2, p0, Landroid/support/v7/view/menu/k;->Mc:I
    ...
    iget-object v0, v0, Landroid/support/v7/widget/ListPopupWindow;->SH:Landroid/support/v7/widget/ListPopupWindow$a;
...
.method public final f(Z)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/k;->Mb:Z

    .line 264
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->LT:Landroid/support/v7/view/menu/k$a;
...
.method public onDismiss()V
    ...
    .line 175
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->LY:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->hE:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/k;->LZ:Landroid/view/ViewTreeObserver;
    ...
    .line 180
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->LZ:Landroid/view/ViewTreeObserver;
