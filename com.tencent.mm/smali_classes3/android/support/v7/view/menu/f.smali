...
# static fields
.field private static final La:[I
...
.field public Ld:Landroid/support/v7/view/menu/f$a;
...
.field public Lg:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private Lk:Landroid/view/ContextMenu$ContextMenuInfo;

.field Ll:Ljava/lang/CharSequence;

.field Lm:Landroid/graphics/drawable/Drawable;

.field Ln:Landroid/view/View;
...
.field public Lt:Ljava/util/concurrent/CopyOnWriteArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field Lu:Landroid/support/v7/view/menu/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/view/menu/f;->La:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 129
    iput v1, p0, Landroid/support/v7/view/menu/f;->Lj:I

    .line 160
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Lo:Z

    .line 162
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Lp:Z

    .line 164
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Lq:Z

    .line 166
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Lr:Z
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Ls:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Lt:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->em:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Le:Ljava/util/ArrayList;

    .line 221
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lf:Z
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Lg:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Lh:Ljava/util/ArrayList;

    .line 225
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Li:Z
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lc:Z
...
.method private static a(Ljava/util/ArrayList;I)I
    ...
    .line 826
    iget v0, v0, Landroid/support/v7/view/menu/h;->Km:I
...
.method private a(ILandroid/view/KeyEvent;)Landroid/support/v7/view/menu/h;
    ...
    .line 903
    iget-object v5, p0, Landroid/support/v7/view/menu/f;->Ls:Ljava/util/ArrayList;
    ...
    .line 922
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->du()Z
...
.method private a(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    .line 870
    :cond_1
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->em:Ljava/util/ArrayList;
...
.method public final C(Z)V
    ...
    .prologue
    .line 997
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lr:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lr:Z

    .line 1000
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Lt:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 1003
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->Lt:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    sget-object v1, Landroid/support/v7/view/menu/f;->La:[I
    ...
    .line 435
    iget v7, p0, Landroid/support/v7/view/menu/f;->Lj:I
    ...
    .line 438
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->Lk:Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    iput-object v1, v0, Landroid/support/v7/view/menu/h;->LG:Landroid/view/ContextMenu$ContextMenuInfo;

    .line 443
    :cond_2
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->em:Ljava/util/ArrayList;

    iget-object v2, p0, Landroid/support/v7/view/menu/f;->em:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v7/view/menu/f$a;)V
    ...
    .prologue
    .line 426
    iput-object p1, p0, Landroid/support/v7/view/menu/f;->Ld:Landroid/support/v7/view/menu/f$a;
...
.method final a(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    .line 1187
    iput-object p3, p0, Landroid/support/v7/view/menu/f;->Ln:Landroid/view/View;

    .line 1190
    iput-object v0, p0, Landroid/support/v7/view/menu/f;->Ll:Ljava/lang/CharSequence;

    .line 1191
    iput-object v0, p0, Landroid/support/v7/view/menu/f;->Lm:Landroid/graphics/drawable/Drawable;
    ...
    .line 1196
    iput-object p1, p0, Landroid/support/v7/view/menu/f;->Ll:Ljava/lang/CharSequence;
    ...
    .line 1202
    iput-object p2, p0, Landroid/support/v7/view/menu/f;->Lm:Landroid/graphics/drawable/Drawable;

    .line 1206
    :cond_2
    iput-object v0, p0, Landroid/support/v7/view/menu/f;->Ln:Landroid/view/View;
...
.method public final a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/l;I)Z
    ...
    .line 960
    iget-object v4, p1, Landroid/support/v7/view/menu/h;->LD:Landroid/support/v4/view/d;
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/view/menu/f;->C(Z)V
    ...
    .line 966
    :cond_5
    invoke-virtual {p0, v2}, Landroid/support/v7/view/menu/f;->C(Z)V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/f;->Lt:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method b(Landroid/support/v7/view/menu/f;Landroid/view/MenuItem;)Z
    ...
    .prologue
    .line 811
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Ld:Landroid/support/v7/view/menu/f$a;
...
.method public final c(Landroid/os/Bundle;)V
    ...
    .line 387
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dt()Ljava/lang/String;
...
.method public clear()V
    ...
    .prologue
    .line 584
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Lu:Landroid/support/v7/view/menu/h;
...
.method public close()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/view/menu/f;->C(Z)V
...
.method public final dA()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Le:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/f;->Le:Ljava/util/ArrayList;
    ...
    .line 1092
    :cond_2
    iput-boolean v2, p0, Landroid/support/v7/view/menu/f;->Lf:Z
...
.method public final dB()V
    ...
    .line 1125
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dA()Ljava/util/ArrayList;

    move-result-object v4

    .line 1127
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Li:Z
    ...
    .line 1138
    :cond_1
    invoke-interface {v1}, Landroid/support/v7/view/menu/l;->D()Z
    ...
    .line 1143
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Lg:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 1144
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Lh:Ljava/util/ArrayList;
    ...
    .line 1149
    iget-object v5, p0, Landroid/support/v7/view/menu/f;->Lg:Ljava/util/ArrayList;
    ...
    .line 1151
    :cond_3
    iget-object v5, p0, Landroid/support/v7/view/menu/f;->Lh:Ljava/util/ArrayList;
    ...
    .line 1161
    :cond_5
    iput-boolean v3, p0, Landroid/support/v7/view/menu/f;->Li:Z

    goto :goto_0
.end method

.method public final dC()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 1170
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dB()V
...
.method public dD()Landroid/support/v7/view/menu/f;
    .locals 0
...
.method du()Z
    ...
    .prologue
    .line 770
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lb:Z
...
.method public dv()Z
    ...
    .prologue
    .line 799
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lc:Z
...
.method public final dw()V
    ...
    .prologue
    .line 1042
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lo:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lo:Z

    .line 1044
    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lp:Z
...
.method public final dx()V
    ...
    .line 1051
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Lp:Z
...
.method public g(Landroid/support/v7/view/menu/h;)Z
    ...
    .line 1318
    :cond_1
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dw()V
    ...
    .line 1330
    iput-object p1, p0, Landroid/support/v7/view/menu/f;->Lu:Landroid/support/v7/view/menu/h;
...
.method public h(Z)V
    ...
    .line 1026
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Lf:Z

    .line 1027
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Li:Z
...
.method public h(Landroid/support/v7/view/menu/h;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->Lu:Landroid/support/v7/view/menu/h;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/f;->Lu:Landroid/support/v7/view/menu/h;
...
.method public performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/view/menu/f;->C(Z)V
...
.method public setGroupCheckable(IZZ)V
    ...
    .line 615
    invoke-virtual {v0, p3}, Landroid/support/v7/view/menu/h;->D(Z)V
...
.method public setGroupVisible(IZ)V
    ...
    .line 632
    invoke-virtual {v0, p2}, Landroid/support/v7/view/menu/h;->F(Z)Z
...
.method public setQwertyMode(Z)V
    ...
    .prologue
    .line 740
    iput-boolean p1, p0, Landroid/support/v7/view/menu/f;->Lb:Z
