...
.field private Pe:Landroid/support/v7/widget/g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatRadioButton;->OY:Landroid/support/v7/widget/h;

    .line 60
    new-instance v0, Landroid/support/v7/widget/g;

    iget-object v1, p0, Landroid/support/v7/widget/AppCompatRadioButton;->OY:Landroid/support/v7/widget/h;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/g;-><init>(Landroid/widget/CompoundButton;Landroid/support/v7/widget/h;)V

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatRadioButton;->Pe:Landroid/support/v7/widget/g;

    .line 61
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatRadioButton;->Pe:Landroid/support/v7/widget/g;
...
.method public getCompoundPaddingLeft()I
    ...
    .line 82
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatRadioButton;->Pe:Landroid/support/v7/widget/g;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/AppCompatRadioButton;->Pe:Landroid/support/v7/widget/g;

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/g;->aS(I)I
...
.method public setButtonDrawable(I)V
    ...
    .prologue
    .line 74
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatRadioButton;->OY:Landroid/support/v7/widget/h;
...
.method public setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/g;->ew()V
