...
.field private final Pf:Landroid/widget/CompoundButton;

.field private Pg:Landroid/content/res/ColorStateList;

.field private Ph:Landroid/graphics/PorterDuff$Mode;
...
.method constructor <init>(Landroid/widget/CompoundButton;Landroid/support/v7/widget/h;)V
    ...
    .line 36
    iput-object v1, p0, Landroid/support/v7/widget/g;->Pg:Landroid/content/res/ColorStateList;

    .line 37
    iput-object v1, p0, Landroid/support/v7/widget/g;->Ph:Landroid/graphics/PorterDuff$Mode;

    .line 38
    iput-boolean v0, p0, Landroid/support/v7/widget/g;->Pi:Z

    .line 39
    iput-boolean v0, p0, Landroid/support/v7/widget/g;->Pj:Z

    .line 51
    iput-object p1, p0, Landroid/support/v7/widget/g;->Pf:Landroid/widget/CompoundButton;

    .line 52
    iput-object p2, p0, Landroid/support/v7/widget/g;->OY:Landroid/support/v7/widget/h;
...
.method private ex()V
    ...
    .prologue
    .line 115
    iget-object v0, p0, Landroid/support/v7/widget/g;->Pf:Landroid/widget/CompoundButton;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/g;->Pi:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/widget/g;->Pj:Z
    ...
    .line 121
    iget-object v1, p0, Landroid/support/v7/widget/g;->Pg:Landroid/content/res/ColorStateList;
    ...
    .line 124
    iget-object v1, p0, Landroid/support/v7/widget/g;->Ph:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 129
    iget-object v1, p0, Landroid/support/v7/widget/g;->Pf:Landroid/widget/CompoundButton;
...
.method final b(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 94
    iput-object p1, p0, Landroid/support/v7/widget/g;->Ph:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 97
    invoke-direct {p0}, Landroid/support/v7/widget/g;->ex()V
...
.method final b(Landroid/util/AttributeSet;I)V
    ...
    .line 63
    iget-object v2, p0, Landroid/support/v7/widget/g;->Pf:Landroid/widget/CompoundButton;

    iget-object v3, p0, Landroid/support/v7/widget/g;->OY:Landroid/support/v7/widget/h;

    iget-object v4, p0, Landroid/support/v7/widget/g;->Pf:Landroid/widget/CompoundButton;
...
.method final e(Landroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 83
    iput-object p1, p0, Landroid/support/v7/widget/g;->Pg:Landroid/content/res/ColorStateList;
...
.method final ew()V
    ...
    .prologue
    .line 105
    iget-boolean v0, p0, Landroid/support/v7/widget/g;->Pk:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/g;->Pk:Z
