...
.field private Tg:Landroid/support/v4/view/ai;

.field private Th:Landroid/support/v4/widget/k;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 1585
    iput-boolean p2, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Te:Z
...
.method static synthetic a(Landroid/support/v7/widget/ListPopupWindow$a;Z)Z
    ...
    .prologue
    .line 1532
    iput-boolean p1, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Td:Z
...
.method protected final fe()Z
    ...
    .prologue
    .line 1726
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Tf:Z
...
.method public final h(Landroid/view/MotionEvent;I)Z
    ...
    .line 1634
    :cond_1
    iput-boolean v1, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Tf:Z
    ...
    iget v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Ty:I
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Tg:Landroid/support/v4/view/ai;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Tg:Landroid/support/v4/view/ai;
    ...
    .line 1639
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Th:Landroid/support/v4/widget/k;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Th:Landroid/support/v4/widget/k;

    .line 1642
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Th:Landroid/support/v4/widget/k;

    invoke-virtual {v0, v2}, Landroid/support/v4/widget/k;->r(Z)Landroid/support/v4/widget/a;
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Tf:Z
    ...
    :cond_a
    iput v6, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Ty:I
    ...
    :cond_f
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ListPopupWindow$a;->P(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/k;->r(Z)Landroid/support/v4/widget/a;
...
.method public final hasFocus()Z
    ...
    .prologue
    .line 1762
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Te:Z
...
.method public final isInTouchMode()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Td:Z
