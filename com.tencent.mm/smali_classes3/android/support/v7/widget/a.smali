...
# instance fields
.field protected final Mi:Landroid/support/v7/widget/a$a;

.field protected final Mj:Landroid/content/Context;

.field protected Mk:Landroid/support/v7/widget/ActionMenuView;

.field protected Ml:Landroid/support/v7/widget/ActionMenuPresenter;

.field protected Mm:I

.field protected Mn:Landroid/support/v4/view/ai;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/a;->Mi:Landroid/support/v7/widget/a$a;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/a;->Mj:Landroid/content/Context;
    ...
    .line 68
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/a;->Mj:Landroid/content/Context;
...
.method public aF(I)V
    ...
    .prologue
    .line 142
    iput p1, p0, Landroid/support/v7/widget/a;->Mm:I
...
.method public c(IJ)Landroid/support/v4/view/ai;
    ...
    .line 161
    iget-object v0, p0, Landroid/support/v7/widget/a;->Mn:Landroid/support/v4/view/ai;
    ...
    .line 171
    iget-object v1, p0, Landroid/support/v7/widget/a;->Mi:Landroid/support/v7/widget/a$a;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 85
    iget-object v0, p0, Landroid/support/v7/widget/a;->Ml:Landroid/support/v7/widget/ActionMenuPresenter;
    ...
    iget-boolean v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->Ns:Z
    ...
    iput v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->Nr:I

    :cond_1
    iget-object v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->ed:Landroid/support/v7/view/menu/f;

    if-eqz v1, :cond_2

    iget-object v0, v0, Landroid/support/v7/widget/ActionMenuPresenter;->ed:Landroid/support/v7/view/menu/f;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 123
    iput-boolean v2, p0, Landroid/support/v7/widget/a;->Mp:Z

    .line 126
    :cond_0
    iget-boolean v1, p0, Landroid/support/v7/widget/a;->Mp:Z
    ...
    .line 129
    iput-boolean v3, p0, Landroid/support/v7/widget/a;->Mp:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 99
    iput-boolean v3, p0, Landroid/support/v7/widget/a;->Mo:Z

    .line 102
    :cond_0
    iget-boolean v1, p0, Landroid/support/v7/widget/a;->Mo:Z
    ...
    .line 105
    iput-boolean v2, p0, Landroid/support/v7/widget/a;->Mo:Z
