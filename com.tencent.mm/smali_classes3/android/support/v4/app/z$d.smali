...
.field public rU:Ljava/lang/CharSequence;

.field public rV:Ljava/lang/CharSequence;

.field public rW:Landroid/app/PendingIntent;

.field rX:Landroid/app/PendingIntent;

.field rY:Landroid/widget/RemoteViews;

.field public rZ:Landroid/graphics/Bitmap;
...
.field public sf:Landroid/support/v4/app/z$r;
...
.field public sn:Ljava/util/ArrayList;
...
.field ss:Landroid/app/Notification;

.field public st:Landroid/app/Notification;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/z$d;->sd:Z
    ...
    iput-object v0, p0, Landroid/support/v4/app/z$d;->sn:Ljava/util/ArrayList;

    .line 911
    iput-boolean v4, p0, Landroid/support/v4/app/z$d;->so:Z

    .line 914
    iput v4, p0, Landroid/support/v4/app/z$d;->sq:I

    .line 915
    iput v4, p0, Landroid/support/v4/app/z$d;->sr:I
    ...
    iput-object v0, p0, Landroid/support/v4/app/z$d;->st:Landroid/app/Notification;

    .line 934
    iput-object p1, p0, Landroid/support/v4/app/z$d;->mContext:Landroid/content/Context;

    .line 937
    iget-object v0, p0, Landroid/support/v4/app/z$d;->st:Landroid/app/Notification;
    ...
    iput-object v0, p0, Landroid/support/v4/app/z$d;->su:Ljava/util/ArrayList;
...
.method public final a(IIZ)Landroid/support/v4/app/z$d;
    ...
    .prologue
    .line 1058
    iput p1, p0, Landroid/support/v4/app/z$d;->sh:I

    .line 1059
    iput p2, p0, Landroid/support/v4/app/z$d;->si:I

    .line 1060
    iput-boolean p3, p0, Landroid/support/v4/app/z$d;->sj:Z
...
.method public final a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/support/v4/app/z$d;
    ...
    .prologue
    .line 1459
    iget-object v0, p0, Landroid/support/v4/app/z$d;->sn:Ljava/util/ArrayList;
...
.method public final a(Ljava/lang/CharSequence;)Landroid/support/v4/app/z$d;
    ...
    iput-object v0, p0, Landroid/support/v4/app/z$d;->rU:Ljava/lang/CharSequence;
...
.method public final b(Ljava/lang/CharSequence;)Landroid/support/v4/app/z$d;
    ...
    iput-object v0, p0, Landroid/support/v4/app/z$d;->rV:Ljava/lang/CharSequence;
...
.method public final build()Landroid/app/Notification;
    ...
    .prologue
    .line 1559
    invoke-static {}, Landroid/support/v4/app/z;->bh()Landroid/support/v4/app/z$i;
...
.method public final n(Z)Landroid/support/v4/app/z$d;
    .locals 1
