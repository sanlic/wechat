...
.field private static final sQ:Ljava/lang/Object;

.field private static sR:Ljava/lang/String;

.field private static sS:Ljava/util/Set;
...
.field private static sV:Landroid/support/v4/app/ag$h;

.field public static final sW:Landroid/support/v4/app/ag$b;


# instance fields
.field public final mContext:Landroid/content/Context;

.field public final sT:Landroid/app/NotificationManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/ag;->sQ:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v4/app/ag;->sS:Ljava/util/Set;
    ...
    sput-object v0, Landroid/support/v4/app/ag;->sW:Landroid/support/v4/app/ag$b;

    .line 172
    :goto_0
    sget-object v0, Landroid/support/v4/app/ag;->sW:Landroid/support/v4/app/ag$b;

    invoke-interface {v0}, Landroid/support/v4/app/ag$b;->bm()I

    move-result v0

    sput v0, Landroid/support/v4/app/ag;->sP:I
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/ag;->sT:Landroid/app/NotificationManager;
...
.method static synthetic bl()I
    ...
    .prologue
    .line 54
    sget v0, Landroid/support/v4/app/ag;->sP:I
...
.method public static k(Landroid/content/Context;)Ljava/util/Set;
    ...
    sget-object v0, Landroid/support/v4/app/ag;->sR:Ljava/lang/String;
    ...
    .line 247
    :cond_1
    sget-object v2, Landroid/support/v4/app/ag;->sQ:Ljava/lang/Object;

    monitor-enter v2

    .line 248
    :try_start_0
    sput-object v3, Landroid/support/v4/app/ag;->sS:Ljava/util/Set;

    .line 249
    sput-object v1, Landroid/support/v4/app/ag;->sR:Ljava/lang/String;
    ...
    .line 252
    :cond_2
    sget-object v0, Landroid/support/v4/app/ag;->sS:Ljava/util/Set;
...
.method public final a(Landroid/support/v4/app/ag$i;)V
    ...
    .prologue
    .line 267
    sget-object v1, Landroid/support/v4/app/ag;->sU:Ljava/lang/Object;

    monitor-enter v1

    .line 268
    :try_start_0
    sget-object v0, Landroid/support/v4/app/ag;->sV:Landroid/support/v4/app/ag$h;
    ...
    sput-object v0, Landroid/support/v4/app/ag;->sV:Landroid/support/v4/app/ag$h;
