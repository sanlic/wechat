...
# instance fields
.field private hQ:Landroid/content/res/ColorStateList;

.field private hR:Landroid/graphics/PorterDuff$Mode;
...
.field private hY:Landroid/support/v7/widget/i;

.field private hZ:Landroid/support/design/widget/l;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hX:Landroid/graphics/Rect;

    .line 116
    invoke-static {p1}, Landroid/support/design/widget/t;->e(Landroid/content/Context;)V

    .line 118
    sget-object v0, Landroid/support/design/a$i;->cz:[I

    sget v1, Landroid/support/design/a$h;->bG:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hQ:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hR:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->hT:I
    ...
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->hU:I
    ...
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->hS:I
    ...
    .line 130
    sget v3, Landroid/support/design/a$i;->cF:I

    invoke-virtual {v1, v3, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Landroid/support/design/widget/FloatingActionButton;->hW:Z
    ...
    iput-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->hY:Landroid/support/v7/widget/i;

    .line 134
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->hY:Landroid/support/v7/widget/i;
    ...
    sget v3, Landroid/support/design/a$d;->aY:I
    ...
    .line 137
    invoke-virtual {p0}, Landroid/support/design/widget/FloatingActionButton;->V()I
    ...
    iput v1, p0, Landroid/support/design/widget/FloatingActionButton;->hV:I

    .line 139
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->W()Landroid/support/design/widget/l;

    move-result-object v1

    iget-object v3, p0, Landroid/support/design/widget/FloatingActionButton;->hQ:Landroid/content/res/ColorStateList;

    iget-object v4, p0, Landroid/support/design/widget/FloatingActionButton;->hR:Landroid/graphics/PorterDuff$Mode;

    iget v5, p0, Landroid/support/design/widget/FloatingActionButton;->hT:I

    iget v6, p0, Landroid/support/design/widget/FloatingActionButton;->hS:I
    ...
    iget v3, v1, Landroid/support/design/widget/l;->ix:F

    cmpl-float v3, v3, v0

    if-eqz v3, :cond_0

    iput v0, v1, Landroid/support/design/widget/l;->ix:F
    ...
    iget v1, v0, Landroid/support/design/widget/l;->iy:F

    cmpl-float v1, v1, v2

    if-eqz v1, :cond_1

    iput v2, v0, Landroid/support/design/widget/l;->iy:F
...
.method private W()Landroid/support/design/widget/l;
    .locals 3
    ...
    .line 653
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hZ:Landroid/support/design/widget/l;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hZ:Landroid/support/design/widget/l;
...
.method static synthetic c(Landroid/support/design/widget/FloatingActionButton;)Landroid/graphics/Rect;
    ...
    .prologue
    .line 61
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hX:Landroid/graphics/Rect;
...
.method static synthetic d(Landroid/support/design/widget/FloatingActionButton;)I
    ...
    .prologue
    .line 61
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton;->hV:I
...
.method static synthetic e(Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .prologue
    .line 61
    iget-boolean v0, p0, Landroid/support/design/widget/FloatingActionButton;->hW:Z
...
.method final V()I
    ...
    .prologue
    .line 349
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton;->hU:I
    ...
    sget v1, Landroid/support/design/a$d;->ba:I
    ...
    sget v1, Landroid/support/design/a$d;->aZ:I
...
.method public getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 188
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hQ:Landroid/content/res/ColorStateList;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .prologue
    .line 215
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hR:Landroid/graphics/PorterDuff$Mode;
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/l;->Z()V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/l;->ab()Z

    move-result v1

    if-eqz v1, :cond_1

    iget-object v1, v0, Landroid/support/design/widget/l;->iC:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iput-object v1, v0, Landroid/support/design/widget/l;->iC:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    :cond_0
    iget-object v1, v0, Landroid/support/design/widget/l;->iA:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v0, v0, Landroid/support/design/widget/l;->iC:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v2, v0, Landroid/support/design/widget/l;->iC:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onMeasure(II)V
    ...
    .line 158
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->hX:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    add-int/2addr v1, v0

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton;->hX:Landroid/graphics/Rect;
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 199
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->hQ:Landroid/content/res/ColorStateList;
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 228
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->hR:Landroid/graphics/PorterDuff$Mode;
...
.method public setImageResource(I)V
    ...
    .prologue
    .line 251
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hY:Landroid/support/v7/widget/i;
