...
.field private ii:Landroid/support/design/widget/r;

.field private ij:Z

.field ik:Landroid/support/design/widget/o;
...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/p;)V
    ...
    iput v0, p0, Landroid/support/design/widget/j;->ih:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->ii:Landroid/support/design/widget/r;

    .line 49
    iget-object v3, p0, Landroid/support/design/widget/j;->ii:Landroid/support/design/widget/r;

    invoke-virtual {v3}, Landroid/support/design/widget/r;->aq()Landroid/view/View;
    ...
    iget-object v0, v3, Landroid/support/design/widget/r;->jE:Ljava/util/ArrayList;
    ...
    :cond_1
    iput-object v7, v3, Landroid/support/design/widget/r;->fn:Ljava/lang/ref/WeakReference;

    iput-object v7, v3, Landroid/support/design/widget/r;->jF:Landroid/support/design/widget/r$a;

    iput-object v7, v3, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;
    ...
    iput-object v0, v3, Landroid/support/design/widget/r;->fn:Ljava/lang/ref/WeakReference;

    .line 52
    :cond_3
    iget-object v0, p0, Landroid/support/design/widget/j;->ii:Landroid/support/design/widget/r;
    ...
    sget-object v1, Landroid/support/design/widget/j;->iz:[I
...
.method private c(Landroid/view/animation/Animation;)Landroid/view/animation/Animation;
    ...
    .prologue
    .line 225
    sget-object v0, Landroid/support/design/widget/a;->ey:Landroid/view/animation/Interpolator;

    invoke-virtual {p1, v0}, Landroid/view/animation/Animation;->setInterpolator(Landroid/view/animation/Interpolator;)V

    .line 226
    iget v0, p0, Landroid/support/design/widget/j;->ih:I
...
.method Z()V
    ...
    iget-object v1, v0, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Landroid/support/design/widget/r;->aq()Landroid/view/View;
    ...
    iget-object v0, v0, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 66
    invoke-static {}, Landroid/support/design/widget/j;->af()Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->it:Landroid/graphics/drawable/Drawable;

    .line 67
    iget-object v0, p0, Landroid/support/design/widget/j;->it:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->iu:Landroid/graphics/drawable/Drawable;

    .line 78
    iget-object v0, p0, Landroid/support/design/widget/j;->iu:Landroid/graphics/drawable/Drawable;

    new-array v1, v6, [[I

    new-array v2, v6, [I

    sget-object v3, Landroid/support/design/widget/j;->iz:[I
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->iv:Landroid/support/design/widget/d;

    .line 83
    new-array v0, v6, [Landroid/graphics/drawable/Drawable;

    iget-object v1, p0, Landroid/support/design/widget/j;->iv:Landroid/support/design/widget/d;

    aput-object v1, v0, v7

    iget-object v1, p0, Landroid/support/design/widget/j;->it:Landroid/graphics/drawable/Drawable;

    aput-object v1, v0, v4

    iget-object v1, p0, Landroid/support/design/widget/j;->iu:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/j;->iw:Landroid/graphics/drawable/Drawable;

    .line 91
    new-instance v0, Landroid/support/design/widget/o;

    iget-object v1, p0, Landroid/support/design/widget/j;->iA:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v1}, Landroid/support/design/widget/VisibilityAwareImageButton;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    iget-object v2, p0, Landroid/support/design/widget/j;->iw:Landroid/graphics/drawable/Drawable;

    iget-object v3, p0, Landroid/support/design/widget/j;->iB:Landroid/support/design/widget/p;

    invoke-interface {v3}, Landroid/support/design/widget/p;->X()F

    move-result v3

    iget v4, p0, Landroid/support/design/widget/j;->ix:F

    iget v5, p0, Landroid/support/design/widget/j;->ix:F

    iget v6, p0, Landroid/support/design/widget/j;->iy:F
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->ik:Landroid/support/design/widget/o;

    .line 97
    iget-object v0, p0, Landroid/support/design/widget/j;->ik:Landroid/support/design/widget/o;

    iput-boolean v7, v0, Landroid/support/design/widget/o;->jl:Z

    invoke-virtual {v0}, Landroid/support/design/widget/o;->invalidateSelf()V

    .line 98
    iget-object v0, p0, Landroid/support/design/widget/j;->iB:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/j;->ik:Landroid/support/design/widget/o;
...
.method a(Landroid/support/design/widget/l$a;Z)V
    ...
    .prologue
    .line 158
    iget-boolean v0, p0, Landroid/support/design/widget/j;->ij:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/j;->iA:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    sget v1, Landroid/support/design/a$a;->aM:I
    ...
    .line 168
    sget-object v1, Landroid/support/design/widget/a;->ez:Landroid/view/animation/Interpolator;
...
.method b(Landroid/support/design/widget/l$a;Z)V
    ...
    sget v1, Landroid/support/design/a$a;->aL:I
...
.method b([I)V
    ...
    iget-object v5, v0, Landroid/support/design/widget/r$a;->jJ:[I
    ...
    :goto_1
    iget-object v0, v3, Landroid/support/design/widget/r;->jF:Landroid/support/design/widget/r$a;
    ...
    iget-object v0, v3, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;
    ...
    iget-object v5, v3, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;
    ...
    :cond_0
    iput-object v2, v3, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;

    :cond_1
    iput-object v1, v3, Landroid/support/design/widget/r;->jF:Landroid/support/design/widget/r$a;

    iget-object v0, v3, Landroid/support/design/widget/r;->fn:Ljava/lang/ref/WeakReference;
    ...
    iput-object v0, v3, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;
    ...
    iget-object v1, v3, Landroid/support/design/widget/r;->jG:Landroid/view/animation/Animation;
...
.method j(F)V
    ...
    iget v1, p0, Landroid/support/design/widget/j;->iy:F
    ...
    .line 134
    invoke-virtual {p0}, Landroid/support/design/widget/j;->ad()V
...
.method k(F)V
    ...
    iget v1, p0, Landroid/support/design/widget/j;->ix:F

    add-float/2addr v1, p1

    iget v2, v0, Landroid/support/design/widget/o;->jg:F
...
.method final setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 106
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/j;->iv:Landroid/support/design/widget/d;
