...
.field private eu:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->ev:Landroid/graphics/Rect;

    .line 54
    sget-object v0, Landroid/support/design/a$i;->cY:[I

    sget v1, Landroid/support/design/a$h;->bI:I
    ...
    iput-object v1, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->et:Landroid/graphics/drawable/Drawable;
...
.method static synthetic a(Landroid/support/design/internal/ScrimInsetsFrameLayout;)Landroid/graphics/Rect;
    ...
    .prologue
    .line 35
    iget-object v0, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->eu:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/design/internal/ScrimInsetsFrameLayout;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .prologue
    .line 35
    iput-object p1, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->eu:Landroid/graphics/Rect;
...
.method static synthetic b(Landroid/support/design/internal/ScrimInsetsFrameLayout;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 35
    iget-object v0, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->et:Landroid/graphics/drawable/Drawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 87
    iget-object v2, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->eu:Landroid/graphics/Rect;

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->et:Landroid/graphics/drawable/Drawable;
    ...
    .line 92
    iget-object v3, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->ev:Landroid/graphics/Rect;

    iget-object v4, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->eu:Landroid/graphics/Rect;
    ...
    .line 93
    iget-object v3, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->et:Landroid/graphics/drawable/Drawable;

    iget-object v4, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->ev:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->eu:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->left:I

    iget-object v6, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->eu:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/design/internal/ScrimInsetsFrameLayout;->ev:Landroid/graphics/Rect;
