...
# instance fields
.field final synthetic el:Landroid/support/design/internal/b;
...
.field private en:Landroid/support/v7/view/menu/h;

.field private eo:Landroid/graphics/drawable/ColorDrawable;
...
.method public constructor <init>(Landroid/support/design/internal/b;)V
    ...
    .prologue
    .line 343
    iput-object p1, p0, Landroid/support/design/internal/b$b;->el:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/internal/b$b;->em:Ljava/util/ArrayList;
...
.method private d(II)V
    ...
    .line 517
    iget-object v0, p0, Landroid/support/design/internal/b$b;->em:Ljava/util/ArrayList;
    ...
    .line 518
    iget-object v0, v0, Landroid/support/design/internal/b$f;->es:Landroid/support/v7/view/menu/h;
    ...
    .line 520
    iget-object v1, p0, Landroid/support/design/internal/b$b;->eo:Landroid/graphics/drawable/ColorDrawable;
    ...
    iput-object v1, p0, Landroid/support/design/internal/b$b;->eo:Landroid/graphics/drawable/ColorDrawable;
...
.method final E()V
    ...
    .prologue
    .line 445
    iget-boolean v0, p0, Landroid/support/design/internal/b$b;->ep:Z
    ...
    iput-boolean v0, p0, Landroid/support/design/internal/b$b;->ep:Z
    ...
    iget-object v1, p0, Landroid/support/design/internal/b$b;->el:Landroid/support/design/internal/b;

    iget-object v1, v1, Landroid/support/design/internal/b;->ed:Landroid/support/v7/view/menu/f;

    invoke-virtual {v1}, Landroid/support/v7/view/menu/f;->dA()Ljava/util/ArrayList;
    ...
    .line 456
    iget-object v0, p0, Landroid/support/design/internal/b$b;->el:Landroid/support/design/internal/b;

    iget-object v0, v0, Landroid/support/design/internal/b;->ed:Landroid/support/v7/view/menu/f;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/h;->D(Z)V
    ...
    .line 467
    iget-object v1, p0, Landroid/support/design/internal/b$b;->em:Ljava/util/ArrayList;

    new-instance v2, Landroid/support/design/internal/b$e;

    iget-object v6, p0, Landroid/support/design/internal/b$b;->el:Landroid/support/design/internal/b;

    iget v6, v6, Landroid/support/design/internal/b;->ek:I
    ...
    invoke-virtual {v1, v12}, Landroid/support/v7/view/menu/h;->D(Z)V
    ...
    .line 484
    :cond_6
    iget-object v12, p0, Landroid/support/design/internal/b$b;->em:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Landroid/support/design/internal/b$b;->el:Landroid/support/design/internal/b;

    iget v5, v5, Landroid/support/design/internal/b;->ek:I

    iget-object v9, p0, Landroid/support/design/internal/b$b;->el:Landroid/support/design/internal/b;

    iget v9, v9, Landroid/support/design/internal/b;->ek:I
    ...
    .line 508
    :cond_b
    iget-object v3, p0, Landroid/support/design/internal/b$b;->em:Ljava/util/ArrayList;
...
.method public final F()Landroid/os/Bundle;
    ...
    .line 541
    iget-object v0, p0, Landroid/support/design/internal/b$b;->en:Landroid/support/v7/view/menu/h;
    ...
    iget-object v2, p0, Landroid/support/design/internal/b$b;->en:Landroid/support/v7/view/menu/h;
    ...
    iget-object v4, v0, Landroid/support/design/internal/b$f;->es:Landroid/support/v7/view/menu/h;
...
.method public final synthetic a(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$t;
    ...
    iget-object v2, p0, Landroid/support/design/internal/b$b;->el:Landroid/support/design/internal/b;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->eb:Landroid/widget/LinearLayout;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$t;)V
    ...
    iget-object v0, p1, Landroid/support/design/internal/b$j;->VQ:Landroid/view/View;

    check-cast v0, Landroid/support/design/internal/NavigationMenuItemView;

    iget-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dX:Landroid/widget/FrameLayout;
    ...
    :cond_0
    iget-object v0, v0, Landroid/support/design/internal/NavigationMenuItemView;->dW:Landroid/widget/CheckedTextView;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$t;I)V
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dZ:Landroid/content/res/ColorStateList;

    iput-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dZ:Landroid/content/res/ColorStateList;

    iget-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dY:Landroid/support/v7/view/menu/h;
    ...
    iget-boolean v1, v1, Landroid/support/design/internal/b;->eg:Z
    ...
    iget v2, v2, Landroid/support/design/internal/b;->ef:I

    iget-object v3, v0, Landroid/support/design/internal/NavigationMenuItemView;->dW:Landroid/widget/CheckedTextView;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->eh:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, v0, Landroid/support/design/internal/NavigationMenuItemView;->dW:Landroid/widget/CheckedTextView;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->ei:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b$f;->es:Landroid/support/v7/view/menu/h;
    ...
    iget-object v1, p1, Landroid/support/design/internal/b$j;->VQ:Landroid/view/View;

    iget v2, v0, Landroid/support/design/internal/b$e;->eq:I

    iget v0, v0, Landroid/support/design/internal/b$e;->er:I
...
.method public final d(Landroid/support/v7/view/menu/h;)V
    ...
    .line 535
    :cond_2
    iput-object p1, p0, Landroid/support/design/internal/b$b;->en:Landroid/support/v7/view/menu/h;
