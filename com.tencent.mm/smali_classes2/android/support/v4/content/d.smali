...
.field private static tI:Landroid/support/v4/content/d;


# instance fields
.field private final mHandler:Landroid/os/Handler;

.field private final tE:Landroid/content/Context;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->tF:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->tG:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->tH:Ljava/util/ArrayList;

    .line 109
    iput-object p1, p0, Landroid/support/v4/content/d;->tE:Landroid/content/Context;
...
.method static synthetic a(Landroid/support/v4/content/d;)V
    ...
    .line 46
    :cond_0
    iget-object v1, p0, Landroid/support/v4/content/d;->tF:Ljava/util/HashMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Landroid/support/v4/content/d;->tH:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v0, v5, Landroid/support/v4/content/d$a;->tK:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Landroid/support/v4/content/d$b;->tL:Landroid/content/BroadcastReceiver;

    iget-object v6, p0, Landroid/support/v4/content/d;->tE:Landroid/content/Context;

    iget-object v7, v5, Landroid/support/v4/content/d$a;->intent:Landroid/content/Intent;
...
.method public static m(Landroid/content/Context;)Landroid/support/v4/content/d;
    .locals 3
    ...
    .line 101
    :try_start_0
    sget-object v0, Landroid/support/v4/content/d;->tI:Landroid/support/v4/content/d;
    ...
    sput-object v0, Landroid/support/v4/content/d;->tI:Landroid/support/v4/content/d;
...
.method public final a(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    .prologue
    .line 134
    iget-object v2, p0, Landroid/support/v4/content/d;->tF:Ljava/util/HashMap;
    ...
    .line 136
    iget-object v0, p0, Landroid/support/v4/content/d;->tF:Ljava/util/HashMap;
    ...
    .line 144
    iget-object v0, p0, Landroid/support/v4/content/d;->tG:Ljava/util/HashMap;
    ...
    .line 147
    iget-object v5, p0, Landroid/support/v4/content/d;->tG:Ljava/util/HashMap;
...
.method public final a(Landroid/content/Intent;)Z
    ...
    .prologue
    .line 201
    iget-object v13, p0, Landroid/support/v4/content/d;->tF:Ljava/util/HashMap;
    ...
    .line 203
    iget-object v1, p0, Landroid/support/v4/content/d;->tE:Landroid/content/Context;
    ...
    .line 215
    :cond_0
    iget-object v1, p0, Landroid/support/v4/content/d;->tG:Ljava/util/HashMap;
    ...
    .line 224
    :cond_2
    iget-boolean v1, v9, Landroid/support/v4/content/d$b;->tM:Z
    ...
    iput-boolean v7, v9, Landroid/support/v4/content/d$b;->tM:Z
    ...
    iput-boolean v3, v1, Landroid/support/v4/content/d$b;->tM:Z
    ...
    .line 260
    :cond_8
    iget-object v1, p0, Landroid/support/v4/content/d;->tH:Ljava/util/ArrayList;
...
.method public final unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    .line 164
    iget-object v8, p0, Landroid/support/v4/content/d;->tF:Ljava/util/HashMap;
    ...
    .line 173
    iget-object v2, p0, Landroid/support/v4/content/d;->tG:Ljava/util/HashMap;
    ...
    iget-object v3, v3, Landroid/support/v4/content/d$b;->tL:Landroid/content/BroadcastReceiver;
