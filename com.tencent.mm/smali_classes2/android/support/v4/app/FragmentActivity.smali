...
.method public getLastCustomNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$b;->qe:Ljava/lang/Object;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v4, v0, Landroid/support/v4/app/FragmentActivity$b;->qg:Landroid/support/v4/e/j;

    iget-object v3, v3, Landroid/support/v4/app/k;->mHost:Landroid/support/v4/app/l;

    iput-object v4, v3, Landroid/support/v4/app/l;->qi:Landroid/support/v4/e/j;
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$b;->qf:Ljava/util/List;
...
.method onReallyStop()V
    ...
    iput-boolean v1, v0, Landroid/support/v4/app/l;->qj:Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-object v0, v6, Landroid/support/v4/app/n;->qo:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/l;->aR()Landroid/support/v4/e/j;
    ...
    .line 553
    iput-object v5, v4, Landroid/support/v4/app/FragmentActivity$b;->qe:Ljava/lang/Object;

    .line 554
    iput-object v1, v4, Landroid/support/v4/app/FragmentActivity$b;->qf:Ljava/util/List;

    .line 555
    iput-object v0, v4, Landroid/support/v4/app/FragmentActivity$b;->qg:Landroid/support/v4/e/j;
...
.method public onStart()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/u;->ba()V
    ...
    iget-object v0, v3, Landroid/support/v4/app/l;->qi:Landroid/support/v4/e/j;
    ...
    iget-boolean v1, v1, Landroid/support/v4/app/u;->oK:Z
    ...
    iget-object v0, v6, Landroid/support/v4/app/u;->rz:Landroid/support/v4/e/k;
    ...
    iget-boolean v7, v0, Landroid/support/v4/app/u$a;->oK:Z

    iget-boolean v8, v0, Landroid/support/v4/app/u$a;->rH:Z
    ...
    iget-boolean v7, v0, Landroid/support/v4/app/u$a;->rF:Z

    if-eqz v7, :cond_8

    iget-boolean v7, v0, Landroid/support/v4/app/u$a;->rI:Z

    if-nez v7, :cond_8

    iget-object v7, v0, Landroid/support/v4/app/u$a;->rE:Landroid/support/v4/content/c;
    ...
    :cond_9
    invoke-virtual {v6}, Landroid/support/v4/app/u;->be()V
...
.method public final setSupportMediaController(Landroid/support/v4/media/session/a;)V
    ...
    .line 211
    iget-object v0, p1, Landroid/support/v4/media/session/a;->ve:Landroid/support/v4/media/session/a$a;

    invoke-interface {v0}, Landroid/support/v4/media/session/a$a;->bw()Ljava/lang/Object;
