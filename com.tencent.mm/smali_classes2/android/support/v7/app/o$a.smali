...
# instance fields
.field final synthetic IM:Landroid/support/v7/app/o;

.field private final IN:Landroid/content/Context;

.field private IO:Landroid/support/v7/view/b$a;
...
.method public constructor <init>(Landroid/support/v7/app/o;Landroid/content/Context;Landroid/support/v7/view/b$a;)V
    ...
    .prologue
    .line 948
    iput-object p1, p0, Landroid/support/v7/app/o$a;->IM:Landroid/support/v7/app/o;

    invoke-direct {p0}, Landroid/support/v7/view/b;-><init>()V

    .line 949
    iput-object p2, p0, Landroid/support/v7/app/o$a;->IN:Landroid/content/Context;

    .line 950
    iput-object p3, p0, Landroid/support/v7/app/o$a;->IO:Landroid/support/v7/view/b$a;
    ...
    iput v1, v0, Landroid/support/v7/view/menu/f;->Lj:I

    iput-object v0, p0, Landroid/support/v7/app/o$a;->ed:Landroid/support/v7/view/menu/f;

    .line 953
    iget-object v0, p0, Landroid/support/v7/app/o$a;->ed:Landroid/support/v7/view/menu/f;
...
.method public final a(Landroid/support/v7/view/menu/f;Landroid/view/MenuItem;)Z
    ...
    .prologue
    .line 1076
    iget-object v0, p0, Landroid/support/v7/app/o$a;->IO:Landroid/support/v7/view/b$a;
...
.method public final b(Landroid/support/v7/view/menu/f;)V
    ...
    .line 1107
    iget-object v0, p0, Landroid/support/v7/app/o$a;->IM:Landroid/support/v7/app/o;
...
.method public final de()Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/o$a;->ed:Landroid/support/v7/view/menu/f;
...
.method public final finish()V
    ...
    iget-object v0, v0, Landroid/support/v7/app/o;->Iv:Landroid/support/v7/app/o$a;
    ...
    iget-object v1, p0, Landroid/support/v7/app/o$a;->IM:Landroid/support/v7/app/o;
    ...
    iput-object p0, v0, Landroid/support/v7/app/o;->Iw:Landroid/support/v7/view/b;

    .line 981
    iget-object v0, p0, Landroid/support/v7/app/o$a;->IM:Landroid/support/v7/app/o;

    iget-object v1, p0, Landroid/support/v7/app/o$a;->IO:Landroid/support/v7/view/b$a;

    iput-object v1, v0, Landroid/support/v7/app/o;->Ix:Landroid/support/v7/view/b$a;

    .line 985
    :goto_1
    iput-object v2, p0, Landroid/support/v7/app/o$a;->IO:Landroid/support/v7/view/b$a;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/app/o;->B(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionBarContextView;->dO()V
    ...
    iget-boolean v1, v1, Landroid/support/v7/app/o;->II:Z
    ...
    iput-object v2, v0, Landroid/support/v7/app/o;->Iv:Landroid/support/v7/app/o$a;
...
.method public final getCustomView()Landroid/view/View;
    ...
    .prologue
    .line 1072
    iget-object v0, p0, Landroid/support/v7/app/o$a;->IP:Ljava/lang/ref/WeakReference;
...
.method public final getMenuInflater()Landroid/view/MenuInflater;
    ...
    iget-object v1, p0, Landroid/support/v7/app/o$a;->IN:Landroid/content/Context;
...
.method public final getSubtitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/ActionBarContextView;->uR:Ljava/lang/CharSequence;
...
.method public final getTitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/ActionBarContextView;->uQ:Ljava/lang/CharSequence;
...
.method public final isTitleOptional()Z
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/ActionBarContextView;->MH:Z
...
.method public final setCustomView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/o$a;->IP:Ljava/lang/ref/WeakReference;
...
.method public final setTitleOptionalHint(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ActionBarContextView;->J(Z)V
