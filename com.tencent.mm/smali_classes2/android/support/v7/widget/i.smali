...
.method public constructor <init>(Landroid/widget/ImageView;Landroid/support/v7/widget/h;)V
    ...
    .line 34
    iput-object p1, p0, Landroid/support/v7/widget/i;->PA:Landroid/widget/ImageView;

    .line 35
    iput-object p2, p0, Landroid/support/v7/widget/i;->OY:Landroid/support/v7/widget/h;
...
.method public final b(Landroid/util/AttributeSet;I)V
    ...
    .line 39
    iget-object v0, p0, Landroid/support/v7/widget/i;->PA:Landroid/widget/ImageView;
    ...
    .line 44
    iget-object v2, p0, Landroid/support/v7/widget/i;->PA:Landroid/widget/ImageView;
    ...
    .line 49
    iget-object v2, p0, Landroid/support/v7/widget/i;->OY:Landroid/support/v7/widget/h;

    iget-object v3, p0, Landroid/support/v7/widget/i;->PA:Landroid/widget/ImageView;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/ap;->Zq:Landroid/content/res/TypedArray;
...
.method public final setImageResource(I)V
    ...
    .line 66
    iget-object v0, p0, Landroid/support/v7/widget/i;->OY:Landroid/support/v7/widget/h;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/widget/i;->OY:Landroid/support/v7/widget/h;

    iget-object v1, p0, Landroid/support/v7/widget/i;->PA:Landroid/widget/ImageView;
