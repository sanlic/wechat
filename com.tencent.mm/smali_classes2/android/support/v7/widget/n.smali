...
.method private static c(Landroid/support/v7/widget/o;)F
    ...
    iget v0, v0, Landroid/support/v7/widget/ae;->Wh:F
...
.method public final a(Landroid/support/v7/widget/o;Landroid/content/Context;IFFF)V
    ...
    iget v3, v0, Landroid/support/v7/widget/ae;->Wk:F

    cmpl-float v3, p6, v3

    if-nez v3, :cond_0

    iget-boolean v3, v0, Landroid/support/v7/widget/ae;->Wl:Z

    if-ne v3, v1, :cond_0

    iget-boolean v3, v0, Landroid/support/v7/widget/ae;->Wm:Z

    if-eq v3, v2, :cond_1

    :cond_0
    iput p6, v0, Landroid/support/v7/widget/ae;->Wk:F

    iput-boolean v1, v0, Landroid/support/v7/widget/ae;->Wl:Z

    iput-boolean v2, v0, Landroid/support/v7/widget/ae;->Wm:Z
    ...
    iget v0, v0, Landroid/support/v7/widget/ae;->Wk:F
