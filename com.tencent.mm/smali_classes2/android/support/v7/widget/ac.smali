...
# instance fields
.field final UW:Landroid/support/v7/widget/RecyclerView;

.field final Wf:Landroid/support/v4/view/a;
...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ac;->Wf:Landroid/support/v4/view/a;

    .line 35
    iput-object p1, p0, Landroid/support/v7/widget/ac;->UW:Landroid/support/v7/widget/RecyclerView;
...
.method public final a(Landroid/view/View;Landroid/support/v4/view/a/b;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ac;->UW:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;

    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;
    ...
    sget-object v1, Landroid/support/v4/view/a/b;->zS:Landroid/support/v4/view/a/b$e;

    iget-object v2, p2, Landroid/support/v4/view/a/b;->zT:Ljava/lang/Object;

    check-cast v0, Landroid/support/v4/view/a/b$k;

    iget-object v0, v0, Landroid/support/v4/view/a/b$k;->zT:Ljava/lang/Object;
...
.method final ga()Z
    ...
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView;->TY:Z

    if-eqz v1, :cond_0

    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView;->Uh:Z
...
.method public final performAccessibilityAction(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v0, v4, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;
    ...
    :cond_2
    iget-object v1, v4, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;
    ...
    :goto_2
    iget-object v3, v4, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;
