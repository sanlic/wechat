...
# instance fields
.field Kd:Landroid/support/v4/view/am;

.field Ke:Z

.field private final Kf:Landroid/support/v4/view/an;

.field private mDuration:J

.field private mInterpolator:Landroid/view/animation/Interpolator;

.field final mc:Ljava/util/ArrayList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->Kf:Landroid/support/v4/view/an;
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->mc:Ljava/util/ArrayList;
...
.method public final a(Landroid/support/v4/view/ai;Landroid/support/v4/view/ai;)Landroid/support/v7/view/h;
    ...
    .prologue
    .line 56
    iget-object v0, p0, Landroid/support/v7/view/h;->mc:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 57
    iget-object v0, p1, Landroid/support/v4/view/ai;->zD:Ljava/lang/ref/WeakReference;
    ...
    sget-object v1, Landroid/support/v4/view/ai;->zH:Landroid/support/v4/view/ai$g;
...
.method public final b(Landroid/support/v4/view/am;)Landroid/support/v7/view/h;
    ...
    .prologue
    .line 109
    iget-boolean v0, p0, Landroid/support/v7/view/h;->Ke:Z

    if-nez v0, :cond_0

    .line 110
    iput-object p1, p0, Landroid/support/v7/view/h;->Kd:Landroid/support/v4/view/am;
...
.method public final cancel()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/h;->Ke:Z

    goto :goto_0
.end method

.method public final dl()Landroid/support/v7/view/h;
    .locals 2
...
.method public final start()V
    ...
    .line 71
    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/h;->Kd:Landroid/support/v4/view/am;

    if-eqz v2, :cond_3

    .line 72
    iget-object v2, p0, Landroid/support/v7/view/h;->Kf:Landroid/support/v4/view/an;
