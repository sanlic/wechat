...
# instance fields
.field final amY:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

.field private final ang:Landroid/os/Parcel;
...
.method constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->ang:Landroid/os/Parcel;

    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->anh:I

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amY:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amY:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    if-nez v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->qZ:Ljava/lang/String;

    :goto_0
    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->ani:I
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->anc:Ljava/lang/String;
...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/c/x;->aw(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/c/s;->g([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/c/s;->h([B)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kM()Z
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kL()I
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kR()Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/x;->aw(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/s;->g([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/s;->h([B)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kO()I
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->amZ:Lcom/google/android/gms/common/server/response/FastJsonResponse$a;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kL()I
...
.method private b(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kK()Z
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kJ()I
...
.method public final kG()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->qZ:Ljava/lang/String;
...
.method protected final kH()Ljava/lang/Object;
    .locals 2
...
.method public final kU()Landroid/os/Parcel;
    .locals 2

    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->ani:I

    packed-switch v0, :pswitch_data_0

    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->ang:Landroid/os/Parcel;
    ...
    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->anj:I

    :pswitch_1
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->ang:Landroid/os/Parcel;

    iget v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->anj:I

    invoke-static {v0, v1}, Lcom/google/android/gms/common/internal/safeparcel/b;->u(Landroid/os/Parcel;I)V

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->ani:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->kU()Landroid/os/Parcel;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amY:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->qZ:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->an(Ljava/lang/String;)Ljava/util/Map;
