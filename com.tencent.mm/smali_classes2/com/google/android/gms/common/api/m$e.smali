...
# instance fields
.field final synthetic aiV:Lcom/google/android/gms/common/api/m;

.field private final aje:Ljava/util/Map;
...
.method public constructor <init>(Lcom/google/android/gms/common/api/m;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/m$e;->aiV:Lcom/google/android/gms/common/api/m;

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lcom/google/android/gms/common/api/m$i;-><init>(Lcom/google/android/gms/common/api/m;B)V

    iput-object p2, p0, Lcom/google/android/gms/common/api/m$e;->aje:Ljava/util/Map;
...
.method public final jW()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/m$e;->aje:Ljava/util/Map;
    ...
    invoke-interface {v0}, Lcom/google/android/gms/common/api/a$b;->jI()Z

    move-result v6

    if-eqz v6, :cond_3

    iget-object v3, p0, Lcom/google/android/gms/common/api/m$e;->aje:Ljava/util/Map;
    ...
    iget v0, v0, Lcom/google/android/gms/common/api/m$d;->ajd:I
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/api/m$e;->aiV:Lcom/google/android/gms/common/api/m;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/m$e;->aiV:Lcom/google/android/gms/common/api/m;

    iget-object v1, v1, Lcom/google/android/gms/common/api/m;->aiB:Lcom/google/android/gms/common/api/o;

    new-instance v2, Lcom/google/android/gms/common/api/m$e$1;

    iget-object v3, p0, Lcom/google/android/gms/common/api/m$e;->aiV:Lcom/google/android/gms/common/api/m;
    ...
    :cond_4
    iget-object v0, p0, Lcom/google/android/gms/common/api/m$e;->aiV:Lcom/google/android/gms/common/api/m;

    iget-boolean v0, v0, Lcom/google/android/gms/common/api/m;->aiN:Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Lcom/google/android/gms/common/api/m$e;->aiV:Lcom/google/android/gms/common/api/m;

    iget-object v0, v0, Lcom/google/android/gms/common/api/m;->aiL:Lcom/google/android/gms/signin/d;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/m$e;->aje:Ljava/util/Map;
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/api/m;->aiB:Lcom/google/android/gms/common/api/o;

    new-instance v3, Lcom/google/android/gms/common/api/m$e$2;

    iget-object v5, p0, Lcom/google/android/gms/common/api/m$e;->aiV:Lcom/google/android/gms/common/api/m;
