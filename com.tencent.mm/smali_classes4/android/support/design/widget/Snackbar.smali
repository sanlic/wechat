...
# static fields
.field private static final jn:Landroid/os/Handler;


# instance fields
.field final jo:Landroid/view/ViewGroup;

.field final jp:Landroid/support/design/widget/Snackbar$SnackbarLayout;

.field private final jq:Landroid/view/accessibility/AccessibilityManager;

.field final jr:Landroid/support/design/widget/q$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/Snackbar;->jn:Landroid/os/Handler;
...
.method static synthetic a(Landroid/support/design/widget/Snackbar;)V
    ...
    .prologue
    .line 68
    invoke-static {}, Landroid/support/design/widget/q;->ap()Landroid/support/design/widget/q;

    move-result-object v0

    iget-object v1, p0, Landroid/support/design/widget/Snackbar;->jr:Landroid/support/design/widget/q$a;
    ...
    iget-object v1, v0, Landroid/support/design/widget/q;->jA:Landroid/support/design/widget/q$b;
    ...
    iget-object v1, v0, Landroid/support/design/widget/q;->jB:Landroid/support/design/widget/q$b;
...
.method static synthetic am()Landroid/os/Handler;
    .locals 1

    .prologue
    .line 68
    sget-object v0, Landroid/support/design/widget/Snackbar;->jn:Landroid/os/Handler;
...
.method static synthetic b(Landroid/support/design/widget/Snackbar;)Landroid/support/design/widget/q$a;
    ...
    .prologue
    .line 68
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->jr:Landroid/support/design/widget/q$a;
...
.method static synthetic c(Landroid/support/design/widget/Snackbar;)Landroid/support/design/widget/Snackbar$SnackbarLayout;
    ...
    .prologue
    .line 68
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->jp:Landroid/support/design/widget/Snackbar$SnackbarLayout;
...
.method static synthetic d(Landroid/support/design/widget/Snackbar;)Z
    ...
    .prologue
    .line 68
    invoke-virtual {p0}, Landroid/support/design/widget/Snackbar;->al()Z
...
.method static synthetic e(Landroid/support/design/widget/Snackbar;)V
    ...
    .prologue
    .line 68
    invoke-virtual {p0}, Landroid/support/design/widget/Snackbar;->ai()V
...
.method final ai()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/Snackbar;->jp:Landroid/support/design/widget/Snackbar$SnackbarLayout;
    ...
    sget-object v1, Landroid/support/design/widget/a;->ey:Landroid/view/animation/Interpolator;
    ...
    sget v1, Landroid/support/design/a$a;->aN:I
...
.method final ak()V
    ...
    iput-object v0, v1, Landroid/support/design/widget/q;->jA:Landroid/support/design/widget/q$b;

    iget-object v0, v1, Landroid/support/design/widget/q;->jB:Landroid/support/design/widget/q$b;
    ...
    iput-object v0, v1, Landroid/support/design/widget/q;->jB:Landroid/support/design/widget/q$b;

    iget-object v0, v1, Landroid/support/design/widget/q;->jA:Landroid/support/design/widget/q$b;

    iget-object v0, v0, Landroid/support/design/widget/q$b;->jD:Ljava/lang/ref/WeakReference;
...
.method final al()Z
    ...
    .prologue
    .line 638
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->jq:Landroid/view/accessibility/AccessibilityManager;
