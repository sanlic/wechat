...
.method public final b(Landroid/support/v4/app/z$d;)Landroid/app/Notification;
    ...
    iget-object v1, p1, Landroid/support/v4/app/z$d;->st:Landroid/app/Notification;

    iget-object v2, p1, Landroid/support/v4/app/z$d;->rU:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/z$d;->rV:Ljava/lang/CharSequence;

    iget-object v4, p1, Landroid/support/v4/app/z$d;->sa:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/z$d;->rY:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/z$d;->sc:I

    iget-object v7, p1, Landroid/support/v4/app/z$d;->rW:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/z$d;->rX:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/z$d;->rZ:Landroid/graphics/Bitmap;
