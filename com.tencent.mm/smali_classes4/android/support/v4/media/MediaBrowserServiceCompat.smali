...
# instance fields
.field private final uo:Landroid/support/v4/e/a;
...
.field private final uq:Landroid/support/v4/media/MediaBrowserServiceCompat$f;

.field ur:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->uo:Landroid/support/v4/e/a;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->uq:Landroid/support/v4/media/MediaBrowserServiceCompat$f;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;)Landroid/support/v4/media/MediaBrowserServiceCompat$f;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->uq:Landroid/support/v4/media/MediaBrowserServiceCompat$f;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 73
    iget-object v0, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->uC:Ljava/util/HashMap;
    ...
    iput v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->um:I
    ...
    iget-object v2, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->uy:Ljava/lang/String;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->uF:Z
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->uD:Ljava/lang/Object;
    ...
    iput-boolean v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->uF:Z

    const/4 v1, 0x0

    iget v2, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->um:I
...
.method static synthetic a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Landroid/os/Bundle;)Z
    ...
    iget-object v0, p1, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->uC:Ljava/util/HashMap;
...
.method static synthetic b(Landroid/support/v4/media/MediaBrowserServiceCompat;)Landroid/support/v4/e/a;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->uo:Landroid/support/v4/e/a;
...
# virtual methods
.method public abstract bu()Landroid/support/v4/media/MediaBrowserServiceCompat$a;
.end method
