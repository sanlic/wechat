...
.field final synthetic PT:Landroid/support/v7/widget/AppCompatSpinner;

.field PW:Ljava/lang/CharSequence;
...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .prologue
    .line 701
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->PT:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->PX:Landroid/graphics/Rect;

    .line 704
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->SS:Landroid/view/View;
    ...
    iput v0, p0, Landroid/support/v7/widget/ListPopupWindow;->SR:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->SU:Landroid/widget/AdapterView$OnItemClickListener;
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$b;)Landroid/widget/ListAdapter;
    ...
    .prologue
    .line 696
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->FL:Landroid/widget/ListAdapter;
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$b;Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->PX:Landroid/graphics/Rect;
...
.method final ez()V
    ...
    .line 740
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->PT:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    .line 751
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->PT:Landroid/support/v7/widget/AppCompatSpinner;

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->FL:Landroid/widget/ListAdapter;

    check-cast v0, Landroid/widget/SpinnerAdapter;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->SG:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->PT:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iget v2, p0, Landroid/support/v7/widget/ListPopupWindow;->PR:I
    ...
    .line 770
    :goto_4
    iput v0, p0, Landroid/support/v7/widget/ListPopupWindow;->SJ:I
    ...
    .line 744
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->PT:Landroid/support/v7/widget/AppCompatSpinner;
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 724
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->FL:Landroid/widget/ListAdapter;
...
.method public final show()V
    ...
    .line 780
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->SH:Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->SH:Landroid/support/v7/widget/ListPopupWindow$a;
