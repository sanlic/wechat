...
.field private static final TF:Z

.field static final TG:Z

.field private static final TH:[Ljava/lang/Class;
...
.field private static final UK:Landroid/view/animation/Interpolator;
...
.field private final TI:Landroid/support/v7/widget/RecyclerView$o;

.field final TJ:Landroid/support/v7/widget/RecyclerView$m;

.field private TK:Landroid/support/v7/widget/RecyclerView$SavedState;

.field TL:Landroid/support/v7/widget/e;

.field TM:Landroid/support/v7/widget/s;

.field final TN:Landroid/support/v7/widget/as;

.field private TO:Z

.field private final TP:Ljava/lang/Runnable;

.field private TQ:Landroid/support/v7/widget/RecyclerView$a;

.field public TR:Landroid/support/v7/widget/RecyclerView$h;

.field private TS:Landroid/support/v7/widget/RecyclerView$n;
...
.field public final TU:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field public TV:Landroid/support/v7/widget/RecyclerView$j;
...
.field private UC:Landroid/support/v7/widget/RecyclerView$e$b;

.field private UD:Z

.field private UE:Landroid/support/v7/widget/ac;

.field private UF:Landroid/support/v7/widget/RecyclerView$d;

.field private final UG:[I

.field private UH:Landroid/support/v4/view/q;

.field private final UI:[I

.field private UJ:Ljava/lang/Runnable;

.field private final UL:Landroid/support/v7/widget/as$b;
...
.field Uj:Landroid/support/v4/widget/i;

.field Uk:Landroid/support/v4/widget/i;

.field Ul:Landroid/support/v4/widget/i;

.field Um:Landroid/support/v4/widget/i;

.field public Un:Landroid/support/v7/widget/RecyclerView$e;
...
.field private final Uw:Landroid/support/v7/widget/RecyclerView$s;

.field final Ux:Landroid/support/v7/widget/RecyclerView$q;

.field public Uy:Landroid/support/v7/widget/RecyclerView$k;

.field public Uz:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private final jq:Landroid/view/accessibility/AccessibilityManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/RecyclerView;->TE:[I
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/widget/RecyclerView;->TF:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v7/widget/RecyclerView;->TG:Z
    ...
    sput-object v0, Landroid/support/v7/widget/RecyclerView;->TH:[Ljava/lang/Class;
    ...
    sput-object v0, Landroid/support/v7/widget/RecyclerView;->UK:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TI:Landroid/support/v7/widget/RecyclerView$o;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TP:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ev:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TT:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TU:Ljava/util/ArrayList;

    .line 311
    iput v2, p0, Landroid/support/v7/widget/RecyclerView;->TZ:I

    .line 328
    iput-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->Uh:Z

    .line 338
    iput v2, p0, Landroid/support/v7/widget/RecyclerView;->Ui:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Un:Landroid/support/v7/widget/RecyclerView$e;

    .line 367
    iput v2, p0, Landroid/support/v7/widget/RecyclerView;->ye:I

    .line 368
    const/4 v0, -0x1

    iput v0, p0, Landroid/support/v7/widget/RecyclerView;->Uo:I

    .line 378
    const/4 v0, 0x1

    iput v0, p0, Landroid/support/v7/widget/RecyclerView;->Uv:F
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uw:Landroid/support/v7/widget/RecyclerView$s;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    .line 388
    iput-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->UA:Z

    .line 389
    iput-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->UB:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UC:Landroid/support/v7/widget/RecyclerView$e$b;

    .line 392
    iput-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->UD:Z

    .line 398
    new-array v0, v4, [I

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UG:[I

    .line 401
    new-array v0, v4, [I

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Dk:[I

    .line 402
    new-array v0, v4, [I

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Dl:[I

    .line 403
    new-array v0, v4, [I

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UI:[I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UJ:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UL:Landroid/support/v7/widget/as$b;
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->Uf:Z
    ...
    iput v3, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I
    ...
    iput v3, p0, Landroid/support/v7/widget/RecyclerView;->Ut:I
    ...
    .line 481
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Un:Landroid/support/v7/widget/RecyclerView$e;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->UC:Landroid/support/v7/widget/RecyclerView$e$b;

    iput-object v3, v0, Landroid/support/v7/widget/RecyclerView$e;->UP:Landroid/support/v7/widget/RecyclerView$e$b;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TL:Landroid/support/v7/widget/e;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TM:Landroid/support/v7/widget/s;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->jq:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UE:Landroid/support/v7/widget/ac;

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UE:Landroid/support/v7/widget/ac;
    ...
    .line 498
    sget-object v0, Landroid/support/v7/d/a$c;->cX:[I
    ...
    .line 501
    sget v3, Landroid/support/v7/d/a$c;->Jo:I
    ...
    :try_start_1
    sget-object v0, Landroid/support/v7/widget/RecyclerView;->TH:[Ljava/lang/Class;
    ...
    .line 507
    sget-object v0, Landroid/support/v7/widget/RecyclerView;->TE:[I
...
.method private Q(II)V
    ...
    .line 1966
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Uj:Landroid/support/v4/widget/i;
    ...
    .line 1967
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uj:Landroid/support/v4/widget/i;
    ...
    .line 1969
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Ul:Landroid/support/v4/widget/i;
    ...
    .line 1972
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Uk:Landroid/support/v4/widget/i;
    ...
    .line 1975
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Um:Landroid/support/v4/widget/i;
...
.method private a(Landroid/support/v7/widget/RecyclerView$t;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    .line 3172
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;
    ...
    .line 3175
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;

    invoke-virtual {v2, v0, v1, p1}, Landroid/support/v7/widget/as;->a(JLandroid/support/v7/widget/RecyclerView$t;)V

    .line 3177
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$t;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$t;->T(Z)V
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView;Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ug:Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Ug:Ljava/util/List;
...
.method private a(IILandroid/view/MotionEvent;)Z
    ...
    .line 1520
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;
    ...
    .line 1525
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;
    ...
    .line 1529
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;
    ...
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/RecyclerView;->Q(Z)V
    ...
    .line 1537
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TT:Ljava/util/ArrayList;
    ...
    .line 1541
    :cond_3
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->Dk:[I
    ...
    .line 1543
    iget v0, p0, Landroid/support/v7/widget/RecyclerView;->Ur:I

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Dk:[I
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView;->Ur:I
    ...
    .line 1546
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Dk:[I
    ...
    .line 1548
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UI:[I
    ...
    .line 1557
    :cond_6
    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/RecyclerView;->S(II)V
    ...
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->Uj:Landroid/support/v4/widget/i;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->Uk:Landroid/support/v4/widget/i;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->Ul:Landroid/support/v4/widget/i;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->Um:Landroid/support/v4/widget/i;
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView;)Z
    ...
    .prologue
    .line 147
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->TY:Z
...
.method static aY(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$t;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Vd:Landroid/support/v7/widget/RecyclerView$t;
...
.method private ag(I)V
    ...
    .prologue
    .line 1208
    iget v0, p0, Landroid/support/v7/widget/RecyclerView;->ye:I
    ...
    .line 1215
    :cond_1
    iput p1, p0, Landroid/support/v7/widget/RecyclerView;->ye:I
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uy:Landroid/support/v7/widget/RecyclerView$k;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uz:Ljava/util/List;
...
.method static synthetic c(Landroid/support/v7/widget/RecyclerView;Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->TM:Landroid/support/v7/widget/s;

    iget-object v3, v2, Landroid/support/v7/widget/s;->Qx:Landroid/support/v7/widget/s$b;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;
    ...
    :cond_1
    iget-object v4, v2, Landroid/support/v7/widget/s;->Qy:Landroid/support/v7/widget/s$a;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/s;->Qx:Landroid/support/v7/widget/s$b;
...
.method private d([I)V
    ...
    .line 3181
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TM:Landroid/support/v7/widget/s;
...
.method static synthetic e(Landroid/support/v7/widget/RecyclerView;)Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->UD:Z
...
.method private f(Landroid/support/v7/widget/RecyclerView$t;)V
    ...
    .line 1102
    iget-object v2, p1, Landroid/support/v7/widget/RecyclerView$t;->VQ:Landroid/view/View;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/s;->Qx:Landroid/support/v7/widget/s$b;
    ...
    :cond_3
    iget-object v3, v0, Landroid/support/v7/widget/s;->Qy:Landroid/support/v7/widget/s$a;
...
.method private fA()Z
    ...
    .prologue
    .line 2772
    iget v0, p0, Landroid/support/v7/widget/RecyclerView;->Ui:I
...
.method private fB()V
    ...
    .prologue
    .line 2824
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->UD:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->TW:Z

    if-eqz v0, :cond_0

    .line 2825
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UJ:Ljava/lang/Runnable;
...
.method private fD()V
    ...
    .line 2844
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TL:Landroid/support/v7/widget/e;
    ...
    iget-boolean v3, p0, Landroid/support/v7/widget/RecyclerView;->TY:Z

    if-eqz v3, :cond_6

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Un:Landroid/support/v7/widget/RecyclerView$e;

    if-eqz v3, :cond_6

    iget-boolean v3, p0, Landroid/support/v7/widget/RecyclerView;->Uh:Z

    if-nez v3, :cond_2

    if-nez v0, :cond_2

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;

    iget-boolean v3, v3, Landroid/support/v7/widget/RecyclerView$a;->UO:Z
    ...
    :goto_2
    iput-boolean v3, v4, Landroid/support/v7/widget/RecyclerView$q;->VI:Z

    .line 2861
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iget-boolean v4, v4, Landroid/support/v7/widget/RecyclerView$q;->VI:Z
    ...
    :goto_3
    iput-boolean v2, v3, Landroid/support/v7/widget/RecyclerView$q;->VJ:Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/e;->eu()V
...
.method private fE()V
    ...
    .line 2892
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;
    ...
    iget v0, v0, Landroid/support/v7/widget/RecyclerView$q;->VB:I
    ...
    iput v2, v0, Landroid/support/v7/widget/RecyclerView$q;->VB:I

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iget-boolean v0, v0, Landroid/support/v7/widget/RecyclerView$q;->VI:Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/as;->aap:Landroid/support/v4/e/e;
    ...
    iget-object v8, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;

    invoke-virtual {v8, v0}, Landroid/support/v7/widget/as;->C(Landroid/support/v7/widget/RecyclerView$t;)Z

    move-result v8

    iget-object v9, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
    ...
    :cond_2
    iget-object v10, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
    ...
    iget-object v11, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->TM:Landroid/support/v7/widget/s;
    ...
    iget-object v9, p0, Landroid/support/v7/widget/RecyclerView;->TM:Landroid/support/v7/widget/s;
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/RecyclerView$a;->UO:Z
    ...
    iget-object v3, v0, Landroid/support/v7/widget/e;->OP:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/e;->OO:Ljava/util/ArrayList;
    ...
    :cond_d
    iput-object v5, v0, Landroid/support/v7/widget/RecyclerView$t;->VV:Landroid/support/v7/widget/RecyclerView$t;

    invoke-direct {p0, v0}, Landroid/support/v7/widget/RecyclerView;->f(Landroid/support/v7/widget/RecyclerView$t;)V

    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;

    invoke-virtual {v6, v0}, Landroid/support/v7/widget/RecyclerView$m;->p(Landroid/support/v7/widget/RecyclerView$t;)V

    invoke-virtual {v5, v1}, Landroid/support/v7/widget/RecyclerView$t;->T(Z)V

    iput-object v0, v5, Landroid/support/v7/widget/RecyclerView$t;->VW:Landroid/support/v7/widget/RecyclerView$t;

    :cond_e
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->Un:Landroid/support/v7/widget/RecyclerView$e;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->UL:Landroid/support/v7/widget/as$b;
    ...
    iget v3, v3, Landroid/support/v7/widget/RecyclerView$q;->VD:I

    iput v3, v0, Landroid/support/v7/widget/RecyclerView$q;->VE:I

    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView;->Uh:Z

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$q;->VI:Z

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$q;->VJ:Z

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;

    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView$h;->d(Landroid/support/v7/widget/RecyclerView$h;)Z

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;

    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView$m;->Vk:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UG:[I

    aget v0, v0, v1

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->UG:[I

    aget v3, v3, v2

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->TM:Landroid/support/v7/widget/s;
    ...
    invoke-virtual {p0, v1, v1}, Landroid/support/v7/widget/RecyclerView;->S(II)V
    ...
    :cond_15
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->UG:[I
...
.method private fF()V
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/RecyclerView$q;->VL:Z
    ...
    iget-boolean v3, v3, Landroid/support/v7/widget/RecyclerView$q;->VJ:Z

    iput-boolean v3, v0, Landroid/support/v7/widget/RecyclerView$q;->VH:Z
    ...
    iput v3, v0, Landroid/support/v7/widget/RecyclerView$q;->VD:I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;

    iget-boolean v5, v5, Landroid/support/v7/widget/RecyclerView$a;->UO:Z

    if-eqz v5, :cond_1

    .line 2947
    :cond_0
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->Un:Landroid/support/v7/widget/RecyclerView$e;

    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;
    ...
    .line 2953
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
    ...
    .line 2954
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iget-boolean v5, v5, Landroid/support/v7/widget/RecyclerView$q;->VK:Z
    ...
    .line 2964
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->TN:Landroid/support/v7/widget/as;
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/RecyclerView$q;->VJ:Z
    ...
    iget v5, v4, Landroid/support/v7/widget/RecyclerView$t;->VR:I
    ...
    iput v5, v4, Landroid/support/v7/widget/RecyclerView$t;->VR:I
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/RecyclerView$q;->VG:Z

    .line 2977
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;

    iput-boolean v2, v3, Landroid/support/v7/widget/RecyclerView$q;->VG:Z
    ...
    iput-boolean v0, v3, Landroid/support/v7/widget/RecyclerView$q;->VG:Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/as;->aao:Landroid/support/v4/e/a;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;
    ...
    iget-object v0, v5, Landroid/support/v7/widget/as;->aao:Landroid/support/v4/e/a;
    ...
    iget-object v5, v5, Landroid/support/v7/widget/as;->aao:Landroid/support/v4/e/a;
    ...
    iput-object v6, v0, Landroid/support/v7/widget/as$a;->aaq:Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    .line 3010
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/RecyclerView;->Q(Z)V
    ...
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$q;->VB:I
...
.method private fG()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$a;->getItemCount()I

    move-result v2

    iput v2, v0, Landroid/support/v7/widget/RecyclerView$q;->VD:I
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$q;->VH:Z

    .line 3028
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->TJ:Landroid/support/v7/widget/RecyclerView$m;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$q;->VG:Z

    .line 3031
    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TK:Landroid/support/v7/widget/RecyclerView$SavedState;

    .line 3034
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;
    ...
    :goto_0
    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$q;->VI:Z
...
.method private fI()V
    ...
    iget-object v0, v3, Landroid/support/v7/widget/RecyclerView$m;->Vl:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v0, v3, Landroid/support/v7/widget/RecyclerView$m;->Vj:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v0, v3, Landroid/support/v7/widget/RecyclerView$m;->Vk:Ljava/util/ArrayList;
...
.method private fJ()V
    ...
    .line 3577
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TM:Landroid/support/v7/widget/s;
    ...
    iget-object v1, v2, Landroid/support/v7/widget/RecyclerView$m;->UM:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;
    ...
    iget-boolean v1, v1, Landroid/support/v7/widget/RecyclerView$a;->UO:Z

    if-eqz v1, :cond_3

    iget-object v1, v2, Landroid/support/v7/widget/RecyclerView$m;->Vl:Ljava/util/ArrayList;
    ...
    iget-object v0, v2, Landroid/support/v7/widget/RecyclerView$m;->Vl:Ljava/util/ArrayList;
...
.method private fK()V
    ...
    iget-object v4, v3, Landroid/support/v7/widget/RecyclerView$t;->VW:Landroid/support/v7/widget/RecyclerView$t;

    if-eqz v4, :cond_1

    .line 4239
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView$t;->VW:Landroid/support/v7/widget/RecyclerView$t;

    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView$t;->VQ:Landroid/view/View;
...
.method private fL()Landroid/support/v4/view/q;
    ...
    .prologue
    .line 11084
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UH:Landroid/support/v4/view/q;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UH:Landroid/support/v4/view/q;
...
.method static synthetic fM()Landroid/view/animation/Interpolator;
    ...
    .prologue
    .line 147
    sget-object v0, Landroid/support/v7/widget/RecyclerView;->UK:Landroid/view/animation/Interpolator;
...
.method static synthetic fN()Z
    ...
    .prologue
    .line 147
    sget-boolean v0, Landroid/support/v7/widget/RecyclerView;->TF:Z
...
.method private fm()V
    ...
    .line 1449
    iget-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->TY:Z
    ...
    .line 1453
    :cond_1
    iget-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->Uh:Z
    ...
    .line 1459
    :cond_2
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->TL:Landroid/support/v7/widget/e;

    invoke-virtual {v2}, Landroid/support/v7/widget/e;->et()Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/e;->er()V

    .line 1470
    iget-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->Ua:Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/e;->et()Z
...
.method private fp()V
    ...
    .prologue
    .line 1894
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uw:Landroid/support/v7/widget/RecyclerView$s;
...
.method private fu()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Um:Landroid/support/v4/widget/i;

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uk:Landroid/support/v4/widget/i;

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ul:Landroid/support/v4/widget/i;

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uj:Landroid/support/v4/widget/i;
...
.method private fv()V
    ...
    .prologue
    .line 2527
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->fq:Landroid/view/VelocityTracker;
...
.method private fx()V
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView;->Ui:I
...
.method private fy()V
    ...
    .line 2732
    iput v1, p0, Landroid/support/v7/widget/RecyclerView;->Ui:I

    .line 2733
    iget v0, p0, Landroid/support/v7/widget/RecyclerView;->Ud:I

    iput v1, p0, Landroid/support/v7/widget/RecyclerView;->Ud:I
...
.method private g(Landroid/support/v7/widget/RecyclerView$t;)J
    ...
    iget-wide v0, p1, Landroid/support/v7/widget/RecyclerView$t;->VS:J
...
.method private h(Landroid/support/v7/widget/RecyclerView$t;)I
    ...
    :cond_2
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->TL:Landroid/support/v7/widget/e;

    iget v1, p1, Landroid/support/v7/widget/RecyclerView$t;->mPosition:I

    iget-object v0, v4, Landroid/support/v7/widget/e;->OO:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroid/support/v7/widget/e$b;->pG:I
    ...
    :sswitch_0
    iget v6, v0, Landroid/support/v7/widget/e$b;->OV:I

    if-gt v6, v1, :cond_3

    iget v0, v0, Landroid/support/v7/widget/e$b;->OX:I
    ...
    iget v7, v0, Landroid/support/v7/widget/e$b;->OX:I
    ...
    iget v1, v0, Landroid/support/v7/widget/e$b;->OX:I
...
.method private m(Landroid/view/MotionEvent;)V
    ...
    iget v2, p0, Landroid/support/v7/widget/RecyclerView;->Uo:I
    ...
    iput v1, p0, Landroid/support/v7/widget/RecyclerView;->Uo:I
    ...
    iput v1, p0, Landroid/support/v7/widget/RecyclerView;->Ur:I

    iput v1, p0, Landroid/support/v7/widget/RecyclerView;->Up:I
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView;->Uq:I
...
.method static synthetic n(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 147
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView;->Uh:Z
...
.method static synthetic p(Landroid/support/v7/widget/RecyclerView;)Z
    ...
    .prologue
    .line 147
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->TX:Z
...
.method static synthetic r(Landroid/support/v7/widget/RecyclerView;)Ljava/lang/Runnable;
    ...
    .prologue
    .line 147
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TP:Ljava/lang/Runnable;
...
.method static synthetic u(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$n;
    ...
    .prologue
    .line 147
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TS:Landroid/support/v7/widget/RecyclerView$n;
...
.method static synthetic v(Landroid/support/v7/widget/RecyclerView;)Landroid/graphics/Rect;
    ...
    .prologue
    .line 147
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ev:Landroid/graphics/Rect;
...
.method static synthetic w(Landroid/support/v7/widget/RecyclerView;)Z
    ...
    .prologue
    .line 147
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->TO:Z
...
.method public final R(Z)V
    ...
    .line 1777
    iput-boolean v7, p0, Landroid/support/v7/widget/RecyclerView;->Ub:Z
    ...
    .line 1781
    :cond_0
    iput-boolean v7, p0, Landroid/support/v7/widget/RecyclerView;->Ua:Z
    ...
    .line 1787
    iput-boolean v8, p0, Landroid/support/v7/widget/RecyclerView;->Ub:Z

    .line 1788
    iput-boolean v8, p0, Landroid/support/v7/widget/RecyclerView;->Uc:Z
...
.method public a(Landroid/support/v7/widget/RecyclerView$a;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TI:Landroid/support/v7/widget/RecyclerView$o;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;
    ...
    iget v0, v1, Landroid/support/v7/widget/RecyclerView$l;->Vi:I

    add-int/lit8 v0, v0, -0x1

    iput v0, v1, Landroid/support/v7/widget/RecyclerView$l;->Vi:I
    ...
    iget-object v0, v1, Landroid/support/v7/widget/RecyclerView$l;->Vg:Landroid/util/SparseArray;
...
.method public final a(Landroid/support/v7/widget/RecyclerView$d;)V
    ...
    .prologue
    .line 1304
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->UF:Landroid/support/v7/widget/RecyclerView$d;
    ...
    .line 1307
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->UF:Landroid/support/v7/widget/RecyclerView$d;
...
.method public final a(Landroid/support/v7/widget/RecyclerView$e;)V
    ...
    iput-object v1, v0, Landroid/support/v7/widget/RecyclerView$e;->UP:Landroid/support/v7/widget/RecyclerView$e$b;

    .line 2715
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->Un:Landroid/support/v7/widget/RecyclerView$e;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->UC:Landroid/support/v7/widget/RecyclerView$e$b;
...
.method public a(Landroid/support/v7/widget/RecyclerView$h;)V
    ...
    iget-object v0, v2, Landroid/support/v7/widget/s;->Qy:Landroid/support/v7/widget/s$a;

    :goto_1
    const-wide/16 v4, 0x0

    iput-wide v4, v0, Landroid/support/v7/widget/s$a;->QA:J

    iget-object v1, v0, Landroid/support/v7/widget/s$a;->QB:Landroid/support/v7/widget/s$a;

    if-eqz v1, :cond_3

    iget-object v0, v0, Landroid/support/v7/widget/s$a;->QB:Landroid/support/v7/widget/s$a;

    goto :goto_1

    :cond_3
    iget-object v0, v2, Landroid/support/v7/widget/s;->Qz:Ljava/util/List;
    ...
    :cond_4
    iget-object v0, v2, Landroid/support/v7/widget/s;->Qx:Landroid/support/v7/widget/s$b;

    invoke-interface {v0}, Landroid/support/v7/widget/s$b;->removeAllViews()V

    .line 1035
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;

    .line 1036
    if-eqz p1, :cond_6

    .line 1037
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v2, p1, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$h;->hn:Z
...
.method public final a(Landroid/support/v7/widget/RecyclerView$k;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uz:Ljava/util/List;
...
.method final bb(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    .line 3894
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Ve:Z

    if-nez v1, :cond_0

    .line 3895
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Ry:Landroid/graphics/Rect;
    ...
    .line 3898
    :cond_0
    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Ry:Landroid/graphics/Rect;

    .line 3899
    invoke-virtual {v2, v4, v4, v4, v4}, Landroid/graphics/Rect;->set(IIII)V

    .line 3900
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TT:Ljava/util/ArrayList;
    ...
    .line 3902
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->ev:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->ev:Landroid/graphics/Rect;
    ...
    .line 3909
    :cond_1
    iput-boolean v4, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Ve:Z
...
.method final c(IIZ)V
    ...
    iput-boolean v6, v3, Landroid/support/v7/widget/RecyclerView$q;->VG:Z
...
.method public computeHorizontalScrollExtent()I
    ...
    .line 1610
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Ux:Landroid/support/v7/widget/RecyclerView$q;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 3325
    :goto_3
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Uk:Landroid/support/v4/widget/i;
    ...
    .line 3327
    iget-boolean v3, p0, Landroid/support/v7/widget/RecyclerView;->TO:Z
    ...
    .line 3333
    :cond_2
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Ul:Landroid/support/v4/widget/i;
    ...
    .line 3342
    :cond_3
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Um:Landroid/support/v4/widget/i;
    ...
    .line 3345
    iget-boolean v4, p0, Landroid/support/v7/widget/RecyclerView;->TO:Z
    ...
    .line 3350
    :goto_7
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->Um:Landroid/support/v4/widget/i;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Un:Landroid/support/v7/widget/RecyclerView$e;
...
.method public final fH()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView$t;->VQ:Landroid/view/View;
...
.method public focusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TQ:Landroid/support/v7/widget/RecyclerView$a;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView;->Ub:Z
...
.method final fr()V
    ...
    .prologue
    .line 2019
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Ul:Landroid/support/v4/widget/i;
...
.method final fs()V
    ...
    .prologue
    .line 2032
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Uk:Landroid/support/v4/widget/i;
...
.method final ft()V
    ...
    .prologue
    .line 2046
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->Um:Landroid/support/v4/widget/i;
...
.method final fz()Z
    ...
    .prologue
    .line 2738
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->jq:Landroid/view/accessibility/AccessibilityManager;
...
.method public getChildDrawingOrder(II)I
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/RecyclerView$d;->ab(II)I
...
.method public isNestedScrollingEnabled()Z
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/q;->xt:Z
...
.method protected onAttachedToWindow()V
    ...
    .line 2125
    iput-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->TW:Z

    .line 2126
    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView;->TY:Z
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/RecyclerView$h;->hn:Z

    .line 2130
    :cond_0
    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView;->UD:Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 2142
    iput-boolean v1, p0, Landroid/support/v7/widget/RecyclerView;->TW:Z
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2577
    :cond_2
    iget v3, p0, Landroid/support/v7/widget/RecyclerView;->Uv:F
    ...
    iput v1, p0, Landroid/support/v7/widget/RecyclerView;->Uv:F

    :cond_3
    iget v1, p0, Landroid/support/v7/widget/RecyclerView;->Uv:F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TV:Landroid/support/v7/widget/RecyclerView$j;

    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TU:Ljava/util/ArrayList;
    ...
    .line 2287
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->TR:Landroid/support/v7/widget/RecyclerView$h;
    ...
    .line 2289
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->fq:Landroid/view/VelocityTracker;
    ...
    iput-object v5, p0, Landroid/support/v7/widget/RecyclerView;->fq:Landroid/view/VelocityTracker;
    ...
    .line 2299
    :pswitch_1
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView;->Uc:Z

    if-eqz v1, :cond_a

    .line 2300
    iput-boolean v3, p0, Landroid/support/v7/widget/RecyclerView;->Uc:Z
    ...
    iput v1, p0, Landroid/support/v7/widget/RecyclerView;->Uq:I

    .line 2306
    iget v1, p0, Landroid/support/v7/widget/RecyclerView;->ye:I
    ...
    .line 2312
    :cond_b
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->UI:[I

    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->UI:[I
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView;->Up:I
    ...
    .line 2331
    :pswitch_3
    iget v5, p0, Landroid/support/v7/widget/RecyclerView;->Uo:I
    ...
    iget v1, p0, Landroid/support/v7/widget/RecyclerView;->Uo:I
    ...
    .line 2340
    iget v7, p0, Landroid/support/v7/widget/RecyclerView;->ye:I

    if-eq v7, v2, :cond_9

    .line 2341
    iget v7, p0, Landroid/support/v7/widget/RecyclerView;->Up:I

    sub-int/2addr v6, v7

    .line 2342
    iget v7, p0, Landroid/support/v7/widget/RecyclerView;->Uq:I
    ...
    iget v7, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I
    ...
    iget v8, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I
    ...
    iget v6, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I

    if-le v4, v6, :cond_e

    .line 2349
    iget v0, p0, Landroid/support/v7/widget/RecyclerView;->Uq:I

    iget v4, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I
...
.method protected onLayout(ZIIII)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView;->TY:Z
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v2, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->ae(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->ac(II)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v7/widget/RecyclerView$h;->ac(II)V
    ...
    .line 2642
    :cond_4
    iget-boolean v2, p0, Landroid/support/v7/widget/RecyclerView;->TX:Z
    ...
    iget-boolean v2, v2, Landroid/support/v7/widget/RecyclerView$q;->VJ:Z
    ...
    iput-boolean v1, v2, Landroid/support/v7/widget/RecyclerView$q;->VH:Z
    ...
    iput v2, v1, Landroid/support/v7/widget/RecyclerView$q;->VD:I
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->ae(II)V
    ...
    iput-boolean v0, v1, Landroid/support/v7/widget/RecyclerView$q;->VH:Z

    goto/16 :goto_0

    .line 2655
    :cond_7
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TL:Landroid/support/v7/widget/e;

    invoke-virtual {v1}, Landroid/support/v7/widget/e;->eu()V
    ...
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$q;->VD:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->TK:Landroid/support/v7/widget/RecyclerView$SavedState;

    .line 1071
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->TK:Landroid/support/v7/widget/RecyclerView$SavedState;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView$SavedState;->Vq:Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->TK:Landroid/support/v7/widget/RecyclerView$SavedState;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView$SavedState;->Vq:Landroid/os/Parcelable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v1, v0, Landroid/support/v7/widget/RecyclerView$SavedState;->Vq:Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->TV:Landroid/support/v7/widget/RecyclerView$j;
    ...
    iput-object v3, p0, Landroid/support/v7/widget/RecyclerView;->TV:Landroid/support/v7/widget/RecyclerView$j;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->fq:Landroid/view/VelocityTracker;
    ...
    .line 2411
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->UI:[I

    iget-object v10, p0, Landroid/support/v7/widget/RecyclerView;->UI:[I
    ...
    .line 2438
    :pswitch_3
    iget v0, p0, Landroid/support/v7/widget/RecyclerView;->Uo:I
    ...
    .line 2450
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->Dl:[I

    iget-object v10, p0, Landroid/support/v7/widget/RecyclerView;->Dk:[I
    ...
    .line 2455
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->UI:[I

    aget v10, v3, v1

    iget-object v11, p0, Landroid/support/v7/widget/RecyclerView;->Dk:[I
    ...
    .line 2459
    :cond_f
    iget v3, p0, Landroid/support/v7/widget/RecyclerView;->ye:I
    ...
    iget v10, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I
    ...
    .line 2463
    iget v3, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I
    ...
    iget v11, p0, Landroid/support/v7/widget/RecyclerView;->iJ:I
    ...
    .line 2478
    invoke-direct {p0, v8}, Landroid/support/v7/widget/RecyclerView;->ag(I)V
    ...
    iput v3, p0, Landroid/support/v7/widget/RecyclerView;->Ur:I
    ...
    iput v3, p0, Landroid/support/v7/widget/RecyclerView;->Us:I
    ...
    iget v3, p0, Landroid/support/v7/widget/RecyclerView;->Uo:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/widget/RecyclerView;->Ub:Z
    ...
    iget v5, p0, Landroid/support/v7/widget/RecyclerView;->Uu:I
    ...
    iget-object v10, p0, Landroid/support/v7/widget/RecyclerView;->Uw:Landroid/support/v7/widget/RecyclerView$s;

    iget-object v0, v10, Landroid/support/v7/widget/RecyclerView$s;->UM:Landroid/support/v7/widget/RecyclerView;

    const/4 v5, 0x2

    invoke-static {v0, v5}, Landroid/support/v7/widget/RecyclerView;->c(Landroid/support/v7/widget/RecyclerView;I)V

    iput v1, v10, Landroid/support/v7/widget/RecyclerView$s;->VN:I

    iput v1, v10, Landroid/support/v7/widget/RecyclerView$s;->VM:I

    iget-object v0, v10, Landroid/support/v7/widget/RecyclerView$s;->iG:Landroid/support/v4/widget/q;
    ...
    .line 2508
    :cond_1c
    invoke-direct {p0, v1}, Landroid/support/v7/widget/RecyclerView;->ag(I)V
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    .line 2093
    iget-boolean v3, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Ve:Z
    ...
    .line 2095
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->ev:Landroid/graphics/Rect;
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView$h;->UW:Landroid/support/v7/widget/RecyclerView;
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    .line 2379
    invoke-interface {v0, p1}, Landroid/support/v7/widget/RecyclerView$j;->S(Z)V
...
.method public sendAccessibilityEventUnchecked(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    :goto_1
    iget v1, p0, Landroid/support/v7/widget/RecyclerView;->Ud:I
...
.method public setClipToPadding(Z)V
    ...
    .line 811
    :cond_0
    iput-boolean p1, p0, Landroid/support/v7/widget/RecyclerView;->TO:Z
...
.method public final smoothScrollBy(II)V
    ...
    .line 1826
    :cond_3
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->Uw:Landroid/support/v7/widget/RecyclerView$s;
