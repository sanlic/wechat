...
# instance fields
.field final OY:Landroid/support/v7/widget/h;

.field private final PG:Landroid/widget/ProgressBar;

.field PH:Landroid/graphics/Bitmap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/j;->KL:[I
...
.method constructor <init>(Landroid/widget/ProgressBar;Landroid/support/v7/widget/h;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/v7/widget/j;->PG:Landroid/widget/ProgressBar;

    .line 49
    iput-object p2, p0, Landroid/support/v7/widget/j;->OY:Landroid/support/v7/widget/h;
...
.method private b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroid/support/v4/b/a/c;->bn()Landroid/graphics/drawable/Drawable;
    ...
    .line 101
    iget-object v0, p0, Landroid/support/v7/widget/j;->PH:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 102
    iput-object v1, p0, Landroid/support/v7/widget/j;->PH:Landroid/graphics/Bitmap;
...
.method b(Landroid/util/AttributeSet;I)V
    ...
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/j;->PG:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/j;->KL:[I
    ...
    .line 58
    iget-object v5, p0, Landroid/support/v7/widget/j;->PG:Landroid/widget/ProgressBar;
    ...
    .line 63
    iget-object v1, p0, Landroid/support/v7/widget/j;->PG:Landroid/widget/ProgressBar;
