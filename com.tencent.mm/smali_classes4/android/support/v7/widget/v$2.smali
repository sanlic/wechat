...
# instance fields
.field final synthetic QW:Landroid/support/v7/widget/v;

.field final synthetic QX:Ljava/util/ArrayList;
...
.method constructor <init>(Landroid/support/v7/widget/v;Ljava/util/ArrayList;)V
    ...
    .prologue
    .line 141
    iput-object p1, p0, Landroid/support/v7/widget/v$2;->QW:Landroid/support/v7/widget/v;

    iput-object p2, p0, Landroid/support/v7/widget/v$2;->QX:Ljava/util/ArrayList;
...
.method public final run()V
    ...
    .line 144
    iget-object v0, p0, Landroid/support/v7/widget/v$2;->QX:Ljava/util/ArrayList;
    ...
    .line 145
    iget-object v5, p0, Landroid/support/v7/widget/v$2;->QW:Landroid/support/v7/widget/v;

    iget-object v1, v0, Landroid/support/v7/widget/v$a;->Rh:Landroid/support/v7/widget/RecyclerView$t;
    ...
    :goto_1
    iget-object v3, v0, Landroid/support/v7/widget/v$a;->Ri:Landroid/support/v7/widget/RecyclerView$t;
    ...
    iget-wide v6, v5, Landroid/support/v7/widget/RecyclerView$e;->UU:J

    invoke-virtual {v1, v6, v7}, Landroid/support/v4/view/ai;->d(J)Landroid/support/v4/view/ai;

    move-result-object v1

    iget-object v6, v5, Landroid/support/v7/widget/v;->QU:Ljava/util/ArrayList;

    iget-object v7, v0, Landroid/support/v7/widget/v$a;->Rh:Landroid/support/v7/widget/RecyclerView$t;

    invoke-virtual {v6, v7}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget v6, v0, Landroid/support/v7/widget/v$a;->Rl:I

    iget v7, v0, Landroid/support/v7/widget/v$a;->Rj:I
    ...
    iget v6, v0, Landroid/support/v7/widget/v$a;->Rm:I

    iget v7, v0, Landroid/support/v7/widget/v$a;->Rk:I
    ...
    iget-object v7, v0, Landroid/support/v7/widget/v$a;->Ri:Landroid/support/v7/widget/RecyclerView$t;
    ...
    iget-wide v8, v5, Landroid/support/v7/widget/RecyclerView$e;->UU:J
    ...
    .line 148
    iget-object v0, p0, Landroid/support/v7/widget/v$2;->QW:Landroid/support/v7/widget/v;

    iget-object v0, v0, Landroid/support/v7/widget/v;->QQ:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v7/widget/v$2;->QX:Ljava/util/ArrayList;
