...
.method static synthetic a(Lcom/tencent/d/a/a/b$a;Landroid/content/Context;)Z
    ...
    .line 248
    invoke-static {}, Lcom/tencent/d/a/a/c;->cym()Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/tencent/d/a/a/c;->ig(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-static {p1}, Lcom/tencent/d/a/a/c;->ih(Landroid/content/Context;)Z
    ...
    invoke-static {p1}, Lcom/tencent/d/a/a/c;->if(Landroid/content/Context;)V
...
.method public final a(Landroid/content/Context;Lcom/tencent/d/a/a/a$d;ILandroid/os/CancellationSignal;Lcom/tencent/d/a/a/a$b;Landroid/os/Handler;)V
    ...
    iget-object v1, p2, Lcom/tencent/d/a/a/a$d;->yZc:Ljavax/crypto/Cipher;

    if-eqz v1, :cond_0

    new-instance v1, Lcom/tencent/d/a/a/b$c;

    iget-object v2, p2, Lcom/tencent/d/a/a/a$d;->yZc:Ljavax/crypto/Cipher;
    ...
    .line 269
    :cond_0
    iget-object v1, p2, Lcom/tencent/d/a/a/a$d;->yZb:Ljava/security/Signature;

    if-eqz v1, :cond_1

    new-instance v1, Lcom/tencent/d/a/a/b$c;

    iget-object v2, p2, Lcom/tencent/d/a/a/a$d;->yZb:Ljava/security/Signature;
    ...
    :cond_1
    iget-object v1, p2, Lcom/tencent/d/a/a/a$d;->yZd:Ljavax/crypto/Mac;

    if-eqz v1, :cond_2

    new-instance v1, Lcom/tencent/d/a/a/b$c;

    iget-object v2, p2, Lcom/tencent/d/a/a/a$d;->yZd:Ljavax/crypto/Mac;
    ...
    :cond_3
    :try_start_0
    invoke-static {p1}, Lcom/tencent/d/a/a/b;->ic(Landroid/content/Context;)Landroid/hardware/fingerprint/FingerprintManager;
    ...
    iget-object v4, v2, Lcom/tencent/d/a/a/b$c;->yZc:Ljavax/crypto/Cipher;

    if-eqz v4, :cond_4

    new-instance v3, Landroid/hardware/fingerprint/FingerprintManager$CryptoObject;

    iget-object v2, v2, Lcom/tencent/d/a/a/b$c;->yZc:Ljavax/crypto/Cipher;
    ...
    :cond_4
    :try_start_1
    iget-object v4, v2, Lcom/tencent/d/a/a/b$c;->yZb:Ljava/security/Signature;

    if-eqz v4, :cond_5

    new-instance v3, Landroid/hardware/fingerprint/FingerprintManager$CryptoObject;

    iget-object v2, v2, Lcom/tencent/d/a/a/b$c;->yZb:Ljava/security/Signature;
    ...
    :cond_5
    iget-object v4, v2, Lcom/tencent/d/a/a/b$c;->yZd:Ljavax/crypto/Mac;

    if-eqz v4, :cond_6

    new-instance v3, Landroid/hardware/fingerprint/FingerprintManager$CryptoObject;

    iget-object v2, v2, Lcom/tencent/d/a/a/b$c;->yZd:Ljavax/crypto/Mac;
...
.method public final ia(Landroid/content/Context;)Z
    .locals 1

    .prologue
    .line 255
    invoke-static {p1}, Lcom/tencent/d/a/a/b;->ia(Landroid/content/Context;)Z
...
.method public final ib(Landroid/content/Context;)Z
    .locals 1

    .prologue
    .line 262
    invoke-static {p1}, Lcom/tencent/d/a/a/b;->ib(Landroid/content/Context;)Z
